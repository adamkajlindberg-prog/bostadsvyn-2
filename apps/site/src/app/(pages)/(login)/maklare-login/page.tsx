    ...
    return  (
        <div className="flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10 @container">
            <div className="flex w-full max-w-md flex-col gap-6">
                <Link href="/" className="flex flex-col self-center hover:opacity-90 hover:scale-105 transition-all duration-300 mb-1.5">
                    ...
                    <div className="text-sm text-muted-foreground text-center">Sveriges smartaste fastighetsmäklarportal</div>
                </Link>
                <BrokerLoginForm />
            </div>
        </div>
