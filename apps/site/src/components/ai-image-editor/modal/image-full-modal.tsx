    ...
    <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center min-h-[100dvh] w-screen">
      ...
      <ReactCompareSlider 
        ref={reactCompareSliderRef}
          itemOne={<ReactCompareSliderImage src={beforeImage} alt="Originalbild" className="max-h-[90dvh] max-w-[90vw] object-contain" />}
          itemTwo={<ReactCompareSliderImage src={afterImage} alt="AI-bild" className="max-h-[90dvh] max-w-[90vw] object-contain" />}
          position={50}
