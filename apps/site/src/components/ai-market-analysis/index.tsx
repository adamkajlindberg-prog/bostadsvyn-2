...
export function AIMarketAnalysis() {
  ...
  const runAnalysis = async () => {
    ...
    setLoading(true);
    try {
      // TODO: Replace with actual API call to /api/ai/market-analysis
      ...
      if (!response.ok) {
        throw new Error("Kunde inte genomföra marknadsanalys");
      }
              ...
              <CardContent>
                ...
                <div className="mt-6 p-4 bg-muted rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    Prognoserna baseras på historiska data, aktuella marknadstrender och
                    ekonomiska indikatorer. Säkerhetsnivå:{" "}
                    {analysisResult.predictions.confidence}%
                  </p>
                </div>
              </CardContent>
