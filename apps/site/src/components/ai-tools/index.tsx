...
import { BotIcon, ChartColumnIcon, HomeIcon, LockIcon, SparklesIcon, WandSparklesIcon } from "lucide-react"
    ...
    return (
        <div className="@container">
            <ContainerWrapper className="py-10">
                <h1 className="text-4xl @lg:text-5xl text-primary text-center font-semibold tracking-tight leading-tight mb-4">AI-Verktyg för Fastigheter</h1>
                <p className="text-lg @lg:text-xl text-center text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-4">
                    Använd avancerad AI-teknik för att förbättra din fastighetsupplevelse - från bildredigering till marknadsanalyser
                </p>
                ...
                <Card className="py-8 shadow-xs">
                    <CardContent className="px-6">
                        ...
                        <h3 className="tezt-xl @lg:text-2xl text-center font-semibold mb-2">Logga in för att använda AI-verktyg</h3>
                        <p className="text-sm @lg:text-base text-muted-foreground text-center max-w-2xl mx-auto mb-8">
                            Skapa ett konto eller logga in för att få tillgång till våra AI-drivna verktyg.
                        </p>
                        <div className="flex justify-center">
                            <Link href="/login">
                                <Button className="py-5 hover:border-transparent w-full @lg:w-auto">Logga in / Registrera</Button>
                            </Link>
                        </div>
                    </CardContent>
                </Card>
