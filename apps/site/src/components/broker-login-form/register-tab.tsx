...
import { Building2Icon, FileDigitIcon, LockIcon, MailIcon, MapIcon, MapPinnedIcon, PhoneIcon, SignpostIcon, UserIcon } from "lucide-react"

const RegisterTab = () => {
    return (
        <>
        <FieldGroup className="gap-y-0 mb-4">
            <div className="text-sm text-primary font-semibold mb-3">Kontorsinformation</div>
            ...
            <div className="text-sm text-primary font-semibold mb-3">Din information som mäklare</div>
            <div className="space-y-4 mb-6">
                <Field>
                ...
                <Field>
                    ...
                    <InputGroup>
                        <InputGroupInput type="text" placeholder="Ditt mäklarlicensnummer" />
                        <InputGroupAddon>
                            <FileDigitIcon />
                        </InputGroupAddon>
                    </InputGroup>
            ...
            <Field>
            <Button type="submit" className="mb-2 bg-green-600 hover:bg-green-700">Registrera mäklarkonto</Button>
