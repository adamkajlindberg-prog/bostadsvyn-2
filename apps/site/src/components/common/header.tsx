...
const Header = () => {
    return (
        <div className="flex items-center justify-between container mx-auto py-4 px-6 sm:px-8 bg-white">
            {/* Logo */}
            ...
            <div className="hidden xl:flex items-center gap-x-8 2xl:gap-x-10">
                {navMenu.map((item) => (
            ...
            <div className="flex items-center gap-x-4">
                <Button variant="outline" className="hidden sm:flex"><Building2Icon /> Mäklare</Button>
                <Button className="hidden sm:flex"><UserIcon /> Logga in</Button>
                ...
                <Sheet>
                    ...
                    <SheetContent className="w-3/4 lg:w-xs">
                        ...
                        <div className="px-4">
                            ...
                            <Button variant="outline" className="flex sm:hidden w-full mt-4"><Building2Icon /> Mäklare</Button>
                            <Button className="flex sm:hidden w-full mt-3"><UserIcon /> Logga in</Button>
                        </div>
                    </SheetContent>
                </Sheet>
            </div> 
