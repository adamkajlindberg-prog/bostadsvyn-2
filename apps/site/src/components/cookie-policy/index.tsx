...
const cookieTypes = [
  {
    ...
    description:
      "Dessa cookies är absolut nödvändiga för att webbplatsen ska fungera och kan inte stängas av. De sätts vanligtvis som svar på dina handlingar, som att logga in eller fylla i formulär.",
    otherContent: () => {
      return (
        <>
          ...
          <p className="text-sm italic mb-2">
            <span className="font-semibold">Rättslig grund</span>: Teknisk
            nödvändighet - inget samtycke krävs enligt lagen om elektronisk
            kommunikation.
          </p>
          <p className="text-sm">
            <span className="font-semibold">Lagringstid</span>: Session (raderas
            när du stänger webbläsaren) till 12 månader
          </p>
        </>
      );
    },
  },
  {
    ...
    description:
      "Dessa cookies möjliggör förbättrad funktionalitet och personalisering. De kan sättas av oss eller av tredjepartsleverantörer vars tjänster vi använder.",
    otherContent: () => {
      return (
        <>
          <div className="bg-background/50 rounded-md p-4 mb-4">
          ...
          <p className="text-sm italic mb-2">
            <span className="font-semibold">Rättslig grund</span>: Samtycke
            enligt lagen om elektronisk kommunikation.
          </p>
          <p className="text-sm">
            <span className="font-semibold">Lagringstid</span>: 3 månader till
            24 månader
          </p>
        </>
      );
  ...
  },
  {
    ...
    title: "Analyscookies",
    description:
      "Dessa cookies hjälper oss att förstå hur besökare interagerar med webbplatsen genom att samla in och rapportera information anonymt.",
    otherContent: () => {
      return (
        <>
          <div className="bg-background/50 rounded-md p-4 mb-4">
          ...
          <p className="text-sm">
            <span className="font-semibold">Lagringstid</span>: 12 månader till
            24 månader
          </p>
        </>
      );
  ...
  },
  {
    ...
    description:
      "Dessa cookies används för att visa annonser som är relevanta för dig och dina intressen. De används också för att begränsa hur många gånger du ser en annons och för att mäta effektiviteten av reklamkampanjer.",
    otherContent: () => {
      return (
        <>
          <div className="bg-background/50 rounded-md p-4 mb-4">
    ...
    <div className="@container">
      <ContainerWrapper className="py-10">
        <div className="flex flex-col @lg:flex-row @lg:items-center flex-wrap gap-2 mb-2">
          ...
          <h2 className="text-2xl @lg:text-3xl font-semibold">Cookie-policy</h2>
        </div>
        ...
        <p className="text-sm @lg:text-base mb-4">
          ...
          eller mobiltelefon) när du besöker en webbplats. De hjälper
          webbplatsen att komma ihåg information om ditt besök, som dina
        ...
        <p className="text-sm @lg:text-base mb-10">
          ...
          analysera hur plattformen används och visa relevant innehåll. Vissa
          cookies är nödvändiga för att webbplatsen ska fungera, medan andra
          kräver ditt samtycke enligt lagen om elektronisk kommunikation.
        </p>
        ...
        <div className="space-y-6 mb-10">
          {cookieTypes.map((cookieType) => (
            <div
              ...
              className="bg-primary/10 border-l-4 border-primary p-6"
            >
        ...
        <Card className="py-6 shadow-none border-2 border-primary bg-primary/10 mb-6">
          <CardContent className="px-6">
            ...
            <p className="text-sm @lg:text-base mb-4">
              När du besöker Bostadsvyn för första gången visas en cookie-banner
              där du kan:
            </p>
            <ul className="list-disc list-inside space-y-2 text-sm @lg:text-base mb-4">
              <li>
                <span className="font-semibold">Acceptera alla</span>: Tillåt
                alla cookies (nödvändiga, funktionella, analyser,
                marknadsföring)
              </li>
              <li>
                <span className="font-semibold">Avböj alla</span>: Endast
                nödvändiga cookies aktiveras
              </li>
              <li>
        ...
        <Card className="py-6 shadow-none border-none bg-primary/5 mb-10">
          <CardContent className="px-6">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-4">
              <p className="text-sm">
                <span className="font-semibold">OBS!</span> Om du blockerar alla
                cookies kan vissa funktioner på webbplatsen sluta fungera. Till
                exempel kan du inte logga in eller spara dina preferenser.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <p className="text-sm @lg:text-base mb-4">
          Förutom cookies använder vi även andra liknande tekniker för att lagra
          information lokalt på din enhet:
        </p>
        <ul className="list-disc list-inside space-y-2 text-sm @lg:text-base mb-4">
          <li>
            <span className="font-semibold">Local Storage</span>: Används för
            att spara dina preferenser och inställningar lokalt
          </li>
          <li>
            <span className="font-semibold">Session Storage</span>: Temporär
            lagring som raderas när du stänger webbläsaren
          </li>
          <li>
            <span className="font-semibold">IndexedDB</span>: Används för
            offline-funktionalitet och caching
          </li>
          <li>
            <span className="font-semibold">Web Beacons</span>: Små transparenta
            bilder som används för att spåra e-postöppningar
          </li>
        </ul>
        <p className="text-sm @lg:text-base mb-10">
        ...
        <p className="text-sm @lg:text-base mb-4">
          Om du har frågor om vår användning av cookies eller hur du hanterar
          dem, kontakta oss gärna:
        </p>
        <Card className="py-6 shadow-none bg-primary/10 mb-10 border-none">
          <CardContent className="px-6">
