          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-muted p-4 rounded-lg border border-border">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  • <strong>Rätt till radering</strong> - "Rätten att bli glömd"
                </li>
                <li>
          ...
          <CardContent className="space-y-4">
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-muted p-4 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Endast behörig personal har tillgång till personuppgifter. All
              ...
              <div className="bg-muted p-4 rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Vi har rutiner för att snabbt upptäcka och hantera eventuella
                  säkerhetsincidenter.
                </p>
              </div>
            </div>
          ...
          <CardContent className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-2">
                Du kan när som helst begära en kopia av alla personuppgifter vi
                har om dig. Vi besvarar din begäran inom 30 dagar.
              </p>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-2">
                Du kan begära att vi raderar dina personuppgifter. Observera att
                vissa uppgifter kan behöva sparas av juridiska skäl (t.ex.
                bokföring).
              </p>
              <div className="bg-muted p-3 rounded text-sm">
                <strong>Så gör du:</strong>
          ...
          <CardContent className="space-y-4">
            <div className="bg-muted p-4 rounded-lg">
              <ul className="space-y-3 text-sm">
                <li>
                  <strong>Kontouppgifter:</strong> Sparas så länge ditt konto är
                  aktivt + 12 månader efter radering
                </li>
                <li>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-muted p-4 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground mb-2">
                ...
                du rätt att lämna klagomål till:
              </p>
              <p className="text-sm">
