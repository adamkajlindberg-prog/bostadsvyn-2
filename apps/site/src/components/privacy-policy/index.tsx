    ...
    contents: () => {
      return (
        <ul className="list-disc list-inside space-y-2 text-sm @lg:text-base">
          ...
          <li>
            Betalningsinformation (hanteras säkert via tredjepartsleverantörer)
          </li>
        </ul>
      );
    },
...
const rights = [
  ...
  },
  {
    ...
    description:
      "Du kan när som helst återkalla ditt samtycke för marknadsföring eller cookies",
  },
];
    ...
    <div className="@container">
      <ContainerWrapper className="py-10">
        ...
        <p className="text-sm @lg:text-base mb-4">
          Bostadsvyn AB (org.nr 559000-0000) värnar om din integritet och
          skyddar dina personuppgifter. Denna integritetspolicy beskriver hur vi
          samlar in, använder, lagrar och delar dina personuppgifter i enlighet
          med EU:s dataskyddsförordning (GDPR) och svensk lag.
        </p>
        <p className="text-sm @lg:text-base mb-10">
          Vi är personuppgiftsansvariga för den behandling av personuppgifter
          som sker på vår plattform.
        </p>
        ...
        <div className="space-y-6 mb-10">
          {personalDataReasons.map((dataReason, index) => (
            <Card
              key={`personal-data-reasons-${index}`}
              className="py-6 shadow-none border-none bg-primary/10"
            >
              <CardContent className="px-6">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm @lg:text-base mb-10">
          <li>
            <span className="font-semibold">Kontoinformation</span>: Så länge
            ditt konto är aktivt och upp till 12 månader efter avslutning
          </li>
          <li>
            <span className="font-semibold">Hyreskontrakt</span>: 7 år enligt
            bokföringslagen
          </li>
          <li>
            <span className="font-semibold">Marknadsföringssamtycke</span>:
            Tills du återkallar ditt samtycke
          </li>
          <li>
            <span className="font-semibold">Analysdata</span>: Anonymiseras
            efter 24 månader
          </li>
          <li>
            <span className="font-semibold">Meddelanden</span>: 24 månader efter
            sista aktivitet
          </li>
        </ul>
        ...
        <p className="text-sm @lg:text-base mb-4">
          Vi säljer aldrig dina personuppgifter. Vi delar uppgifter endast när
          det är nödvändigt:
        </p>
        <ul className="list-disc list-inside space-y-2 text-sm @lg:text-base mb-10">
          <li>
            <span className="font-semibold">Fastighetsmäklare</span>: När du
            kontaktar en mäklare genom plattformen
          </li>
          <li>
            <span className="font-semibold">BankID</span>: För autentisering och
            signering av hyreskontrakt
          </li>
          <li>
            <span className="font-semibold">Betalningsleverantörer</span>: För
            säker hantering av transaktioner
          </li>
          <li>
            <span className="font-semibold">Molntjänstleverantörer</span>: För
            hosting och lagring (inom EU/EES)
          </li>
          <li>
            <span className="font-semibold">Myndighetskrav</span>: När lagen
            kräver det (t.ex. Skatteverket, Polisen)
          </li>
        </ul>
        ...
        <div className="space-y-3.5 mb-4">
          {rights.map((item, index) => (
            <div
              key={`right-${index}`}
              className="bg-primary/10 border-l-4 border-primary p-4"
            >
        ...
        <p className="text-sm @lg:text-base mb-10">
          ...
          ändringar kommer vi att informera dig via e-post eller genom en tydlig
          notis på webbplatsen. Vi rekommenderar att du regelbundet granskar
          denna sida.
        </p>
        ...
        <Card className="py-6 shadow-none border-none bg-primary/10">
          <CardContent className="px-6">
            <ul className="space-y-2 text-sm @lg:text-base">
              ...
              <li>
                <span className="font-semibold">Postadress</span>: Bostadsvyn
                AB, [Adress], [Postnummer] [Stad]
              </li>
            </ul>
          </CardContent>
        </Card>
