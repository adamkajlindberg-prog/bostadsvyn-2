    ...
    <Card className="py-6 shadow-xs">
      <CardContent className="px-6">
        ...
        <div className="py-3 my-3 border-y">
          <div className="text-sm font-semibol mb-1.5">
        ...
        <div className="bg-primary/10 text-muted-foreground text-xs p-3.5 rounded-md mb-3">
          Detta är en uppskattning för fastighetsköp. Faktiska kostnader kan
          variera beroende på fastighetens storlek och läge.
        </div>
