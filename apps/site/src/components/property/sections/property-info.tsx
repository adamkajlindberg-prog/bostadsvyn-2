  ...
  return (
    <Card className="py-6 shadow-xs">
      <CardContent className="px-6">
        <div className="flex flex-col @4xl:flex-row @4xl:justify-between items-start mb-6 gap-6">
          <div className="order-2 @4xl:order-1">
            ...
            <div className="flex items-start text-muted-foreground gap-1.5">
              ...
              <div className="text-sm @lg:text-base">
                Strandvägen 42, 182 68 Djursholm
              </div>
            </div>
          </div>
          ...
          <div className="order-1 @4xl:order-2 flex flex-wrap self-start @lg:self-end @4xl:self-start gap-2">
            ...
            <Link href="/ai-bildredigering">
              <Button
                variant="ghost"
                className="text-sm font-medium bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 hover:from-purple-600 hover:via-pink-600 hover:to-orange-600 text-white border-0"
              >
        ...
        <div className="text-2xl @lg:text-3xl text-primary font-bold mb-0.5">
          18 500 000 kr
        </div>
        ...
        <div className="py-6 border-b">
          ...
          <p className="text-sm @lg:text-base text-muted-foreground">
            ...
            Genomgående exklusiva materialval, rymliga sällskapsytor och perfekt
            planlösning för familjen som värdesätter kvalitet och komfort.
          </p>
        </div>
