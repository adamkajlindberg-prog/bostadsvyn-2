...
const Rentals = () => {
  return (
    <Card className="border shadow-xs bg-card py-7">
      <CardContent className="px-7">
        ...
        <div className="flex flex-col items-center pb-12 pt-10">
          ...
          <div className="text-lg @lg:text-xl font-semibold mb-2 text-center">
            Inga hyresbostäder hittades
          </div>
          <div className="text-sm @lg:text-base text-muted-foreground text-center">
