        ...
        <div className="@4xl:col-span-8 @5xl:col-span-9">
            <Card className="py-0 shadow-xs mb-6 overflow-hidden">
                <CardContent className="px-0">
                    ...
                    <iframe className="w-full" height="400" id="gmap_canvas" src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=%20%C3%96stersund+(bostadsvyn-map)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" />
                </CardContent>
            </Card>

            <div className="flex flex-wrap gap-2 bg-primary/10 p-2.5 mb-4 rounded-xl">
                {filters.map((filter, index) => (
                    <Button key={`filter-${index}`} variant={filter.value === "all" ? "default" : "outline"} className="hover:border-transparent">
                        {filter.label}
                    </Button>
                ))} 
            </div>
