        ...
        <div className="flex flex-col @5xl:flex-row">
          <div className="bg-primary-light/10 @5xl:w-[70%] overflow-hidden">
            ...
            >
              ...
              <button
                type="button"
                className="absolute bottom-3 right-3 @lg:bottom-5 @lg:right-5 bg-neutral-100 p-3 rounded-full shadow text-gray-600 cursor-pointer hover:bg-neutral-200 hover:text-gray-500"
              >
              ...
              <div className="absolute -translate-y-[18px] top-1/2 hidden @lg:justify-between @lg:w-full px-5 @lg:group-hover:flex">
                <button
                  ...
                  className="bg-black/50 text-primary-foreground rounded-full p-3 hover:bg-black/60 cursor-pointer"
                >
          ...
          <div className="p-5 @5xl:w-[30%] flex flex-col">
            ...
            <div className="text-2xl text-primary font-bold mb-7">
