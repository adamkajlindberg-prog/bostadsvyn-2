...
import { BrainIcon, CalendarIcon, ClockIcon, FunnelIcon, SlidersHorizontalIcon, SparklesIcon, WavesIcon } from "lucide-react"
        ...
        <Card className="@4xl:col-span-4 @5xl:col-span-3 py-6 shadow-xs">
            <CardContent className="px-6">
                ...
                <div className="mb-6">
                    ...
                    <Input type="text" className="text-sm" placeholder="T.ex. Stockholm" />
                </div>

                <Button variant="outline" className="border-2 border-primary hover:border-transparent w-full" onClick={() => setAdvancedOpen((state) => !state)}>
                ...
                {advancedOpen && (
                    <>
                        <div className="mt-6 pt-6 border-t">
                            <div className="mb-6">
                                <Label className="text-sm font-medium mb-2">Prisintervall (SEK)</Label>
                                <div className="grid grid-cols-2 gap-2.5">
                                    <Input type="number" min={0} className="text-sm" placeholder="Från" />
                                    <Input type="number" min={0} className="text-sm" placeholder="Till" />
                                </div>
                            </div>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex justify-between">
                                    <div className="text-sm text-muted-foreground">0 m<sup>2</sup></div>
                                    <div className="text-sm text-muted-foreground">1000 m<sup>2</sup></div>
                                </div>
                            </div>
                        ...
                        <div className="mt-6 pt-6 border-t">
                            ...
                            <div className="flex flex-col gap-2 mb-6">
                                {characteristics.map((characteristic) => (  
                                    <div key={characteristic.value} className="flex items-center gap-2.5">
                                        <Checkbox value={characteristic.value} />
                                        <Label className="text-sm font-normal">{characteristic.label}</Label>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {energyClasses.map((energyClass) => (
                                    <div key={energyClass}>
                                        <Button size="sm"  variant="outline" className="border-2 border-primary hover:border-transparent w-full">
                                            {energyClass}
                                        </Button>
                                    </div>
                                ))}
                        ...
                        <div className="mt-6 pt-6 border-t">
                            ...
                            <div className="mb-6">
                                <Label className="text-sm font-medium mb-2">Avgift (kr/mån)</Label>
                                <div className="grid grid-cols-2 gap-2.5">
                                    <Input type="number" min={0} className="text-sm" placeholder="Min" />
                                    <Input type="number" min={0} className="text-sm" placeholder="Max" />
                                </div>
                            </div>

                            <div className="mb-6">
                                <Label className="text-sm font-medium mb-2">Tomtarea (m²)</Label>
                                <div className="grid grid-cols-2 gap-2.5">
                                    <Input type="number" min={0} className="text-sm" placeholder="Min" />
                                    <Input type="number" min={0} className="text-sm" placeholder="Max" />
                                </div>
                        ...
                        <div className="mt-6 pt-6 border-t">
                            <div className="mb-6">
                                <div className="flex items-center gap-2 mb-3">
                                    ...
                                    <Label className="text-sm font-medium">Dagar på plattformen</Label>
                                </div>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="flex items-center gap-2.5">
                                    <Checkbox />
                                    <Label className="text-sm font-normal">Dölj borttagen före visning</Label>
                                </div>
                            </div>
                            ...
                            <div className="mb-6">
                                <div className="flex items-center gap-2 mb-2">
                                    <WavesIcon size={16} />
                                    <Label className="text-sm font-medium">Avstånd till vatten</Label>
                                </div>
                            ...
                            <Card className="py-4 shadow-xs bg-accent/10 border border-accent/40">
                             <CardContent className="px-4">
                                <div className="flex justify-end mb-4">
                                    <div className="text-xs text-white font-medium bg-primary py-0.5 px-2.5 rounded-full">Kräver konto</div>
                                </div>

                                <div className="flex flex-wrap items-center gap-2.5 mb-3">
                                    <BrainIcon size={16} className="text-primary" />
                                    <div className="text-sm font-semibold">AI-Rekommendationer</div>
                                </div>
                                
                                <p className="text-sm text-muted-foreground mb-4 break-words whitespace-normal">
                                    Få personliga fastighetsrekommendationer baserade på dina tidigare sökningar.
                                </p>
