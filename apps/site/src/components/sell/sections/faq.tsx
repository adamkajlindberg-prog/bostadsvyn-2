...
const faqs = [
  {
    ...
    answer:
      "Ja, du kan uppgradera eller nedgradera ditt paket när som helst. Ändringar träder i kraft omedelbart.",
  },
  {
    question: "Vad händer med mina annonser när jag nedgraderar?",
    answer:
      "Dina annonser fortsätter att köras men med funktionerna från din nya nivå. Premiumfunktioner kommer att inaktiveras.",
  },
  {
    question: "Erbjuder ni återbetalning?",
    answer:
      "Vi erbjuder 30 dagars pengarna-tillbaka-garanti för alla premiumpaket om du inte är nöjd.",
  },
];
