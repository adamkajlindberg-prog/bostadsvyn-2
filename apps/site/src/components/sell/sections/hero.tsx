...
const sellingSteps = [
  {
    ...
    description:
      "Få en kostnadsfri värdering på 1 minut baserat på aktuella marknadsdata",
  },
  {
    icon: <UserCheckIcon />,
    title: "Hitta rätt mäklare",
    description:
      "Få skräddarsydda rekommendationer baserat på ditt område, bostadstyp och mäklarnas rekommendationer och resultat",
  },
  {
    icon: <CameraIcon />,
    title: "Mäklaren skapar annons",
    description:
      "Din mäklare publicerar annonsen med alla optimeringar och hanterar försäljningen via våra smarta konton",
  },
  {
    icon: <SparklesIcon />,
    title: "Direkt marknadsföring",
    description:
      "Som säljare kan du via ditt konto själv publicera ditt objekt via våra marknadskanaler för att nå fler spekulanter",
  },
  {
    icon: <TrendingUpIcon />,
    title: "Uppnå högsta pris",
    description:
      "Följ intresse, statistik och sälj till bästa möjliga slutpris med hjälp av våra smarta paket",
  },
];
...
const brokerFeatures = [
  ...
  },
  {
    ...
    description:
      "Mäklarna får tillgång till våra kraftfulla AI-verktyg för homestyling och prissättning",
  },
  {
    title: "Resultatbaserade rekommendationer",
    description:
      "Vi matchar dig med mäklare baserat på deras rekommendationer och track record i ditt område",
  },
];
    ...
    <>
      <div className="flex items-center justify-center flex-wrap gap-4 mb-4">
        ...
        <div className="bg-primary text-xs text-primary-foreground rounded-full px-3 py-1.5">
          AI-assisterad försäljning
        </div>
      </div>

      <h1 className="text-4xl @lg:text-5xl text-primary text-center font-semibold tracking-tight leading-tight mb-4">
        Sälj din bostad smart
      </h1>
      <p className="text-lg @lg:text-xl text-center text-muted-foreground max-w-3xl mx-auto leading-relaxed mb-12">
        Maximera värdet på din bostad med AI-drivna verktyg och Sveriges bästa
        mäklare. Vi ger dig verktygen och kopplar dig till rätt mäklare för att
        uppnå högsta möjliga slutpris.
      </p>
        ...
        {highlights.map((highlight) => (
          <Card key={highlight.title} className="py-6 shadow-xs">
            <CardContent className="px-6">
              ...
              <h5 className="text-base text-center font-semibold mb-2">
                {highlight.title}
              </h5>
      ...
      <Card className="py-6 mb-10 shadow-xs">
        <CardContent className="px-6">
          <h3 className="text-xl @lg:text-2xl font-semibold tracking-tight mb-2">
            Så här säljer du smartast med Bostadsvyn
          </h3>
          <p className="text-muted-foreground mb-6">
            Vi kombinerar kraftfulla AI-verktyg med professionella mäklares
            expertis för att säkerställa att du uppnår högsta möjliga slutpris
          </p>
        ...
        <CardContent className="px-6">
          <div className="flex @lg:items-center flex-wrap mb-6 gap-4 @lg:gap-2">
            ...
            <h3 className="text-xl @lg:text-2xl font-semibold tracking-tight">
              Professionella mäklare som gör skillnad
            </h3>
          </div>
          <p className="text-muted-foreground mb-6">
            På Bostadsvyn kan endast certifierade mäklare publicera
            försäljningsannonser. Detta säkerställer kvalitet, juridisk säkerhet
            och att du får professionell support genom hela processen. Våra
            AI-verktyg fungerar som kraftfulla hjälpmedel som mäklaren använder
            för att maximera värdet på din bostad.
          </p>
