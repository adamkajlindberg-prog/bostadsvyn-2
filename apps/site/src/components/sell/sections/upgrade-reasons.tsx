...
const reasons = [
  {
    ...
    description:
      "Få upp till 10x fler visningar med premium-placering och utvalda annonser",
  },
  {
    icon: <ZapIcon size={30} />,
    title: "Snabbare försäljning",
    description:
      "Fastigheter med premiumannonser säljs 40% snabbare än standardannonser",
  },
  {
    icon: <CrownIcon size={30} />,
    title: "Professionella verktyg",
    description:
      "Tillgång till AI-drivna insikter, avancerad analys och marknadsföringsverktyg",
  },
];
  ...
  return (
    <Card className="py-6 shadow-xs mt-12">
      <CardContent className="px-6">
        <h3 className="text-xl @lg:text-2xl text-center font-semibold tracking-tight mb-6">
          Varför uppgradera?
        </h3>
