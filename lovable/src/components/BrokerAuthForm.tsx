...
export default function BrokerAuthForm() {
  ...
  const { signIn, signUpBroker } = useAuth();
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: signUpError } = await signUpBroker(
        email,
        password,
        fullName,
        phone,
            ...
            <Tabs defaultValue="signin" className="w-full">
              ...
              <TabsContent value="signup">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="text-sm font-bold text-primary mb-3 mt-4">
                ...
                <div className="mt-4 text-center text-xs font-medium text-foreground">
                  Genom att registrera dig accepterar du våra villkor för
                  mäklare och bekräftar att du har rätt att representera din
                  mäklarbyrå.
                </div>
              </TabsContent>
            </Tabs>
