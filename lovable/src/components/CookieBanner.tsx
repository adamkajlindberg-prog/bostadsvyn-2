              ...
              <div className="space-y-4 mb-6">
                <div className="flex items-center justify-between p-3 border rounded-lg bg-muted/30">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Krävs för grundläggande funktionalitet som inloggning,
                      sessionshantering och säkerhet
                    </p>
                    <p className="text-xs text-muted-foreground italic">
                      Exempel: Autentiseringstoken, språkval,
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Hjälper oss förstå hur webbplatsen används och förbättra
                      användarupplevelsen
                    </p>
                    <p className="text-xs text-muted-foreground italic">
                      Exempel: Sidvisningar, klick, användarbeteende
                      (anonymiserat)
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground italic">
                      Exempel: Annonsvisningar, konverteringsspårning,
                      retargeting
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Förbättrar funktionalitet och personalisering baserat på
                      dina val
                    </p>
                    <p className="text-xs text-muted-foreground italic">
                      Exempel: Sparade sökningar, visningspreferenser,
                      favoritlistor
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
