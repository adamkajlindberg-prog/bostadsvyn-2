...
import { Brain, TrendingUp, FileText, Shield, Sparkles, Users, Calculator, Search } from 'lucide-react';
...
const features = [{
  ...
  description: 'Lär sig dina preferenser och rekommenderar nya bostäder baserat på din sökhistorik',
  badge: 'Smart',
  color: 'text-accent',
...
const FeatureSection = () => {
  return <section className="py-20 bg-gradient-to-b from-nordic-ice to-background">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        {/* Intro Section */}
        <div className="text-center mb-20">
          <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Bostadsvyn</h2>
          <div className="max-w-4xl mx-auto space-y-6">
            <p className="text-lg text-foreground font-medium leading-relaxed">
              Välkommen till framtidens bostadsportal med det bredaste utbudet av bostäder i både Sverige och utlandet. Hos oss hittar du allt från <span className="font-semibold">villor</span>, <span className="font-semibold">gårdar</span>, <span className="font-semibold">lägenheter</span>, <span className="font-semibold">tomter</span> och <span className="font-semibold">fritidshus</span> till <span className="font-semibold">radhus</span>, <span className="font-semibold">kedjehus</span>, <span className="font-semibold">parhus</span>, <span className="font-semibold">hyresbostäder</span>, <span className="font-semibold">nyproduktion</span> och <span className="font-semibold">kommersiella fastigheter</span> – allt på samma plattform.
            </p>
            <p className="text-lg text-foreground font-medium leading-relaxed">Vår vision är att revolutionera bostadsmarknaden genom att kombinera cutting-edge AI-teknologi med personlig service och rådgivning. Vi är här för att hjälpa dig genom hela processen och göra din största affär till en trygg och smidig upplevelse – oavsett om du köper, säljer eller hyr. </p>
          </div>
        </div>
        ...
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-5">Smarta verktyg för modern fastighetshantering</h2>
          <p className="text-base text-foreground font-medium max-w-3xl mx-auto leading-relaxed">
            AI-drivna lösningar som gör bostadsprocessen enklare och mer transparent.
          </p>
        </div>
          ...
          <Card className="overflow-hidden shadow-elevated bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
            <div className="p-8 lg:p-12">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-7">
                <div>
                  <h4 className="text-sm font-semibold text-foreground mb-3">Inredning & Design:</h4>
                ...
                <div>
                  <h4 className="text-sm font-semibold text-foreground mb-3">Renovering & Finish:</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-foreground text-sm font-medium">
                      <div className="w-1.5 h-1.5 bg-primary rounded-full" />
                      Golv, väggar och tak
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="relative">
                <img src={livingRoomBefore} alt="Vardagsrum före AI-homestyling" className="w-full h-full object-cover" />
              ...
              <div className="relative">
                <img src={livingRoomAfter} alt="Vardagsrum efter AI-homestyling med nya färger" className="w-full h-full object-cover" />
        ...
        <div className="mb-16">
          <Card className="overflow-hidden shadow-elevated bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
            <div className="p-8 lg:p-12">
              ...
              <h3 className="text-xl md:text-2xl font-semibold text-foreground mb-3">Visualisera renoveringar, förändringar och tillbyggnader</h3>
              <p className="text-foreground text-base font-medium mb-5 leading-relaxed">Vårt AI-verktyg låter dig enkelt lägga till eller ta bort element från fastighetbilder. Visa potentialen i både utomhus- och exteriörutrymmen genom att visualisera förändringar och tillbyggnader. Via chatten på det specifika objektet får du resultatet på sekunder.</p>
              <div className="grid md:grid-cols-2 gap-6 mb-7">
                <div>
                  <h4 className="text-sm font-semibold text-foreground mb-3">Lägg till:</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-foreground text-sm font-medium">
                      <div className="w-1.5 h-1.5 bg-primary rounded-full" />
                ...
                <div>
                  <h4 className="text-sm font-semibold text-foreground mb-3">Byt ut:</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-foreground text-sm font-medium">
                      <div className="w-1.5 h-1.5 bg-primary rounded-full" />
                      Tak och fasad
              ...
              <Button variant="nordic" size="lg" className="w-fit" asChild>
                
              </Button>
            </div>
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="relative">
                <img src={villaBeforeEdit} alt="Villa före redigering" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-l from-background/20 to-transparent" />
                <div className="absolute top-4 left-4 bg-background/90 backdrop-blur-sm px-3 py-1 rounded-full text-sm font-medium">
                  Före
                </div>
              ...
              <div className="relative">
                <img src={villaAfterEdit} alt="Villa efter redigering med terrass och pool" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-r from-background/20 to-transparent" />
                <div className="absolute top-4 right-4 bg-primary text-primary-foreground px-3 py-1 rounded-full text-sm font-medium">
                  Efter
                </div>
              ...
              <Card className="group hover:shadow-card transition-all duration-300 hover:scale-105 bg-card/40 backdrop-blur-lg border border-primary-foreground/20 cursor-pointer h-full">
                <CardContent className="p-8">
                  ...
                  <div className="space-y-2">
                    {feature.benefits.map((benefit, idx) => <div key={idx} className="flex items-center gap-2 text-sm text-foreground font-medium">
                        <div className="w-1.5 h-1.5 bg-primary rounded-full" />
                        {benefit}
                      </div>)}
                  </div>
