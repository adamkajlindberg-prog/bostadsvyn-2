import { Eye, FileText, Phone, Shield } from "lucide-react";

const LegalFooter = () => {
  return (
    <footer className="bg-nordic-midnight text-nordic-snow py-12 mt-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand Section */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-nordic-aurora">
              Bostadsvyn.se
            </h3>
            <p className="text-sm text-nordic-mist">
              Sveriges modernaste fastighetsportal med AI-teknologi och digital
              säkerhet.
            </p>
          ...
          <div className="space-y-3">
            <h4 className="font-semibold text-nordic-fjord">
              Juridisk Information
            </h4>
            <div className="space-y-2 text-sm">
              <a
                href="/privacy"
                className="flex items-center gap-2 hover:text-nordic-aurora transition-colors"
              >
          ...
          <div className="space-y-3">
            ...
            <div className="text-xs text-nordic-mist space-y-1 mt-4">
              <p>
                * AI-redigerade bilder är märkta som fotomontage enligt FMI:s
                riktlinjer
              </p>
              <p>
                * Prisanalys är prognoser och garanterar ej faktiska
                marknadsvärden
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-nordic-mist/20 mt-8 pt-6 text-center text-xs text-nordic-mist">
          <p>
            © 2025 Bostadsvyn Sverige AB. Alla rättigheter förbehållna. Org.nr:
            559551-3176
          </p>
        </div>
      </div>
