...
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImV2Z3plYnZ6cmloc3FmcWhtd3hvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTg0ODQ4MjQsImV4cCI6MjA3NDA2MDgyNH0.278oaiUZQFbQUk6IhLsTCvxUmN7Og3jTOrNw18I1sXs";
...
const NyproduktionProperties: React.FC<NyproduktionPropertiesProps> = ({
  ...
  useEffect(() => {
    applyFilters();
  }, [properties, search, minPrice, maxPrice, type, sort]);
      ...
      const mockProperties = [
        {
          ...
          description: 'Extraordinär sekelskiftesvåning med ursprungliga detaljer och modern komfort.'
        },
        {
          ...
          ad_tier: 'plus',
          is_nyproduktion: true,
          description: 'Trevligt radhus i barnvänligt område. Egen trädgård, nyrenoverat kök.'
        }
      ];
    ...
    return (
      <div className="text-center py-12">
        <p className="text-muted-foreground">
          {isLoading ? 'Laddar...' : 'Inga nyproduktionsobjekt hittades med dina filter.'}
        </p>
      </div>
    );
  }
