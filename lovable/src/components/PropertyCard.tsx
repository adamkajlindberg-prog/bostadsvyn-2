...
export default function PropertyCard({
  ...
  const videoEmbedUrl = property.video_url
    ? getVideoEmbedUrl(property.video_url)
    : null;
  ...
  }, [user, checkIfFavorite, loadUserGroup]);
  ...
  const addToGroup = async () => {
    if (!user || !userGroup) {
      toast({
        title: "Ingen grupp",
        description:
          "Du måste vara medlem i en grupp för att lägga till objekt",
        variant: "destructive",
      });
      return;
    }
  ...
  const handleCardClick = (e: React.MouseEvent) => {
    ...
    if (managementMode) {
      ...
      if (
        ...
        !property.nyproduktion_project_id &&
        property.nyproduktion_total_units &&
        property.nyproduktion_total_units > 0
      ) {
  ...
  if (isRental) {
    return (
      <Card
        className={cn(
          "w-full max-w-5xl mx-auto overflow-hidden hover:shadow-xl transition-all duration-300 group border-l-4 border-l-rental",
              ...
              <div className="text-xl font-bold text-rental flex items-center gap-2">
                ...
                <span className="text-xs font-normal text-muted-foreground">
                  ...
                  {property.living_area
                    ? `${Math.round(property.price / property.living_area)} kr/m²`
                    : ""}
                  )
                </span>
              </div>
                  ...
                  <div className="grid grid-cols-2 gap-x-3 gap-y-1.5 text-xs">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <div>
                        ...
                        <span className="font-semibold">
                          {property.rental_info.furnished ? "Ja" : "Nej"}
                        </span>
                      </div>
                    </div>
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-semibold">
                        {property.rental_info.pets_allowed ? "Ja" : "Nej"}
                      </span>
                    </div>
                    <div className="flex items-center gap-1">
  ...
  if (cardSize === "large") {
    ...
    return (
      <Card
        className={cn(
          "w-full mx-auto overflow-hidden hover:shadow-2xl transition-all duration-500 group border-2 border-primary/30 bg-gradient-to-br from-background to-primary/5",
          !disableClick && "cursor-pointer",
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 py-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {property.tenure_type && (
                    <div>
                      ...
                      <div className="font-bold text-sm">
                        {tenureTypeLabels[property.tenure_type] ||
                          property.tenure_type}
                      </div>
                    </div>
                  )}
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  {property.property_type === "Lägenhet" &&
                ...
                {property.price_per_sqm && (
                  <div>
                    ...
                    <div className="font-bold text-sm">
                      {property.price_per_sqm.toLocaleString("sv-SE")} kr/m²
                    </div>
                  </div>
                )}
              </div>
  ...
  if (cardSize === "medium") {
    ...
    return (
      <Card
        className={cn(
          "w-full max-w-5xl mx-auto overflow-hidden hover:shadow-xl transition-all duration-400 group border border-info/40 bg-gradient-to-br from-background to-info/5",
          !disableClick && "cursor-pointer",
        )}
        onClick={handleCardClick}
      >
              ...
              <div className="space-y-1.5 py-2 text-sm">
                ...
                {property.price_per_sqm && (
                  <div>
                    ...
                    <span className="font-bold">
                      {property.price_per_sqm.toLocaleString("sv-SE")} kr
                    </span>
                  </div>
                )}
              </div>
  ...
  return (
    <Card
      className={cn(
        "w-full max-w-5xl mx-auto overflow-hidden hover:shadow-lg transition-all duration-300 group",
        !disableClick && "cursor-pointer",
      )}
      onClick={handleCardClick}
    >
