...
export const PropertyDashboard: React.FC = () => {
  ...
  const [_editingProperty, _setEditingProperty] = useState<string | null>(null);
  ...
  }, [canManageProperties, bypass, loadProperties]);
  ...
  const _deleteProperty = async (propertyId: string) => {
        ...
        <Card>
          <CardContent className="text-center py-8">
            ...
            <p className="text-muted-foreground">
              Du måste vara säljare, mäklare eller admin för att hantera
              fastigheter.
            </p>
          </CardContent>
        </Card>
