...
export default function PropertyListings() {
  ...
  const [_favorites, setFavorites] = useState<Set<string>>(new Set());
  const { user } = useAuth();
  useEffect(() => {
    fetchProperties();
  }, [fetchProperties]);
    ...
    try {
      ...
      const testProperties: Property[] = [
        ...
        // FREE - 2 annonser
        {
          ...
          ad_tier: "free",
          description:
            "Trevlig tvåa i populära Vasastan med bra kommunikationer och nära till service.",
          broker: {
        ...
        },
        {
          ...
          ad_tier: "free",
          description:
            "Liten men smart planerad lägenhet med perfekt läge nära tunnelbanan.",
          broker: {
            name: "Peter Nilsson",
            avatar_url:
  ...
  const _handleFavorite = (propertyId: string) => {
    setFavorites((prev) => {
  ...
  if (loading) {
    return (
      <section className="py-12 bg-nordic-ice">
      ...
      <div className="container mx-auto px-4">
        <Card className="shadow-card">
          ...
          <CardContent>
            {properties.length === 0 ? (
              ...
              >
                {properties.map((property) => {
                  ...
                  return (
                    <div key={property.id} className={span}>
                      <PropertyCard
                        property={property}
                        size={viewMode === "list" ? "large" : undefined}
                      />
                    </div>
                  );
                })}
            ...
            {/* Load More Button */}
            {properties.length > 0 && properties.length % 9 === 0 && (
