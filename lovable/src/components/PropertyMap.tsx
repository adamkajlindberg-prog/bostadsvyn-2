...
import { AlertCircle, Bath, Bed, MapPin, Square } from "lucide-react";
...
const _DEFAULT_CENTER = { lat: 62.0, lng: 15.0 };
...
const BoundaryOverlay: React.FC<{ selectedLocation?: any }> = ({
  selectedLocation,
}) => {
  const map = useMap();
        ...
        <APIProvider apiKey={GOOGLE_MAPS_API_KEY}>
          ...
          >
            ...
            {properties.map((property) => {
              ...
              const _isHovered = hoveredProperty === property.id;
                        ...
                        {selectedProperty.living_area && (
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-muted-foreground">
                              {selectedProperty.living_area} m²
                            </span>
                          </div>
                        )}
                        ...
                        <div className="grid grid-cols-1 gap-1 text-[10px] pt-1">
                          ...
                          {selectedProperty.monthly_fee && (
                            <div className="text-muted-foreground">
                              Avgift:{" "}
                              <span className="font-medium">
                                {selectedProperty.monthly_fee.toLocaleString(
                                  "sv-SE",
                                )}{" "}
                                kr/mån
                              </span>
