...
export const PropertySearch: React.FC<PropertySearchProps> = ({
  ...
  const [naturalSearchQuery, setNaturalSearchQuery] = useState(
    searchParams.get("query") || searchParams.get("searchQuery") || "",
  );
  ...
  const _loadAiRecommendations = async () => {
    if (!user) {
      toast({
        title: "Logga in för AI-rekommendationer",
        description:
          "Skapa ett konto för att få personliga fastighetsrekommendationer baserade på dina sökningar.",
      });
      return;
    }
    ...
    try {
      ...
      const response = await fetch(
        "/functions/v1/ai-property-recommendations",
        {
          method: "POST",
          headers: {
  ...
  const loadProperties = async () => {
    try {
      ...
      const testProperties: Property[] = [
        // PREMIUM - 3 annonser
        {
          ...
          images: [
            ...
            "https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1600585152915-d208bec867a1?w=1200&h=675&fit=crop",
        ...
        },
        {
          ...
          images: [
            ...
            "https://images.unsplash.com/photo-1600047509358-9dc75507daeb?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1600047509782-20d39509f26d?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1600047509608-f57c2647775e?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1600047509418-62a1ffa95cb5?w=1200&h=675&fit=crop",
          ],
          created_at: new Date(
          ...
          description:
            "Extraordinär sekelskiftesvåning med ursprungliga detaljer och modern komfort. Stuckatur, kakelugnar och kristallkronor möter nutida kök och badrum. Exklusivt läge vid Strandvägen.",
          viewing_times: [
            {
              date: "2025-11-14",
              time: "18:00-19:00",
        ...
        },
        {
          ...
          images: [
            ...
            "https://images.unsplash.com/photo-1600573472592-401b489a3cdc?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1600573472550-8090b5e0745e?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1600563438938-a9a27216b4f5?w=1200&h=675&fit=crop",
          ],
          created_at: new Date(
          ...
          ad_tier: "premium",
          description:
            "Nybyggd lyxvilla med högsta tänkbara standard. Pool, spa-avdelning, hembiograf och vinkällare. Fantastisk sjöutsikt och egen brygga. Perfekt för den som söker det absolut bästa.",
          broker: {
        ...
        // PLUS - 3 annonser
        {
          ...
          images: [
            ...
            "https://images.unsplash.com/photo-1560448204-444092475094?w=800&h=600&fit=crop",
          ...
          show_bidding: true,
          description:
            "Ljus och välplanerad lägenhet med centralt läge. Nyrenoverad med moderna lösningar och fin balkong mot lugn innergård.",
          viewing_times: [
            {
              date: "2025-11-16",
              time: "13:00-14:00",
        ...
        },
        {
          ...
          is_nyproduktion: true,
          description:
            "Trevligt radhus i barnvänligt område. Egen trädgård, nyrenoverat kök och närhet till skolor och kommunikationer.",
          broker: {
            name: "Johan Karlsson",
            avatar_url:
        ...
        },
        {
          ...
          ad_tier: "plus",
          description:
            "Ljus lägenhet på Södermalm med härlig balkong och vacker utsikt över staden. Smart planlösning och fint skick.",
          broker: {
            name: "Lisa Svensson",
            avatar_url:
        ...
        // Fritidshus
        {
          ...
          ad_tier: "premium",
          description:
            "Mysigt fritidshus med direkt sjötomt och egen brygga. Perfekt för familjen.",
        ...
        // Tomter
        {
          ...
          ad_tier: "premium",
          description:
            "Attraktiv byggnadstomt med havsutsikt. Detaljplan finns för villa på 250 kvm.",
        ...
        // Gård
        {
          ...
          ad_tier: "premium",
          description:
            "Vacker lantgård med bostadshus, ekonomibyggnader och 8,5 hektar mark.",
        ...
        // Additional COMING_SOON properties
        {
          ...
          ad_tier: "premium",
          description:
            "Fantastisk takvåning med stor takterrass och otrolig utsikt över Stockholm.",
        ...
        },
        {
          ...
          ad_tier: "premium",
          description:
            "Totalrenoverad villa i lugnt läge med närhet till Brommaplan och grönområden.",
        ...
        },
        {
          ...
          ad_tier: "plus",
          description:
            "Fräsch tvåa i hjärtat av Södermalm med balkong och soligt läge.",
        ...
        },
        {
          ...
          ad_tier: "plus",
          description:
            "Välplanerat parhus i populärt område med bra kommunikationer.",
        ...
        },
        {
          ...
          ad_tier: "plus",
          description:
            "Trivsam trea med högt till tak och fina originaldetaljer från sekelskiftet.",
        ...
        },
        {
          ...
          ad_tier: "free",
          description:
            "Mysig fjällstuga i Sälen med nära till liftar och skidbackar.",
        ...
        },
        {
          ...
          ad_tier: "premium",
          description:
            "Helt nyrenoverad lägenhet med balkong och fantastisk sjöutsikt.",
        ...
        },
        {
          ...
          ad_tier: "free",
          description:
            "Charmig etta perfekt för den som söker sitt första boende i stan.",
        ...
        },
        {
          ...
          ad_tier: "premium",
          description:
            "Exklusiv villa med egen sjötomt och brygga. Panoramautsikt över havet.",
        ...
        // Fler kommersiella fastigheter
        {
          ...
          images: [
            ...
            "https://images.unsplash.com/photo-1552566626-52f8b828add9?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1551218808-94e220e084d2?w=1200&h=675&fit=crop",
          ],
          created_at: new Date().toISOString(),
          user_id: "test",
          ad_tier: "premium",
        ...
        },
        {
          ...
          longitude: 17.9142,
          images: [
            "https://images.unsplash.com/photo-1553413077-190dd305871c?w=1200&h=675&fit=crop",
        ...
        },
        {
          ...
          images: [
            ...
            "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=1200&h=675&fit=crop",
          ],
          created_at: new Date().toISOString(),
          user_id: "test",
          ad_tier: "premium",
        ...
        },
        {
          ...
          longitude: 18.064,
          images: [
            "https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1555529669-2269763671c0?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1528698827591-e19ccd7bc23d?w=1200&h=675&fit=crop",
          ],
          created_at: new Date().toISOString(),
          user_id: "test",
        ...
        },
        {
          ...
          images: [
            ...
            "https://images.unsplash.com/photo-1571902943202-507ec2618e8f?w=1200&h=675&fit=crop",
            "https://images.unsplash.com/photo-1540497077202-7c8a3999166f?w=1200&h=675&fit=crop",
          ],
          created_at: new Date().toISOString(),
          user_id: "test",
          ad_tier: "plus",
        ...
        // Fler "Snart till salu" fastigheter
        {
          ...
          ad_tier: "premium",
          description:
            "Nybyggd arkitektritad villa i naturskönt läge. Skandinavisk design i harmoni med naturen. Pool, spa och vinkällare. Inflyttning Q2 2025.",
          features: [
            "Nyproduktion",
            "Pool",
            "Spa",
        ...
        },
        {
          ...
          ad_tier: "premium",
          description:
            "Spektakulär penthouse med 360-graders utsikt över Stockholm och vattnet. Takterrass på 120 kvm med jacuzzi. Unik möjlighet!",
          features: [
            "Takterrass",
            "Jacuzzi",
            "Panoramautsikt",
        ...
        },
        {
          ...
          ad_tier: "premium",
          description:
            "Magnifik herrgård från 1700-talet på 12,5 hektar mark med egen skogsfastighet. Totalrenoverad med bibehållen historisk charm. Egen sjö, stall och ekonomibyggnader.",
          features: [
            "Herrgård",
            "Historisk",
            "Egen sjö",
        ...
        },
        {
          ...
          ad_tier: "plus",
          description:
            "Prisvärd nyproducerad tvåa perfekt för singeln eller paret.",
        ...
        },
        {
          ...
          ad_tier: "free",
          description:
            "Kompakta och smarta studentlägenheter nära universitetet.",
          features: [
            "Nyproduktion",
            "Nära universitet",
            "Smart inredning",
      ...
      const premTpl = testProperties.find(
        (p) => p.ad_tier === "premium" && p.status !== "FOR_RENT",
      );
      const plusTpls = testProperties
        .filter((p) => p.ad_tier === "plus" && p.status !== "FOR_RENT")
        .slice(0, 2);
      const freeTpl = testProperties.find(
        (p) => p.ad_tier === "free" && p.status !== "FOR_RENT",
      );
      const rentTpl = testProperties.find((p) => p.status === "FOR_RENT");
      const demoProperties: Property[] = [];
      for (let day = 0; day <= 7; day++) {
        const hours = day === 0 ? [1, 2, 3, 4, 5] : [10, 12, 14, 16, 18];
        const makeTs = (h: number) =>
          new Date(
            Date.now() - (day * 24 * 60 * 60 * 1000 + h * 60 * 60 * 1000),
          ).toISOString();
  ...
  const isSwedishProperty = (property: Property): boolean => {
    ...
    if (
      ...
      swedishPostalCodePattern.test(property.address_postal_code)
    ) {
      return true;
    }
  ...
  const getFilteredCountForTab = useCallback(
    (
      ...
      if (filters.listingType) {
        filtered = filtered.filter(
          (property) => property.status === filters.listingType,
        );
      }
      ...
      if (filters.listingType === "FOR_RENT") {
        filtered = filtered.filter(
          (property) =>
            property.price >= filters.minRent &&
            property.price <= filters.maxRent,
        );
      } else {
        filtered = filtered.filter(
          (property) =>
      ...
      if (filters.energyClass.length > 0) {
        filtered = filtered.filter(
          (property) =>
            ...
            filters.energyClass.includes(property.energy_class),
        );
      }
      ...
      if (tabType === "ALL") {
        ...
        filtered = filtered.filter(
          (property) => property.status === "COMING_SOON",
        );
      } else if (tabType === "COMMERCIAL") {
        filtered = filtered.filter(
          (property) =>
            property.property_type === "COMMERCIAL" ||
            property.property_type === "Kommersiell",
        );
      } else if (tabType === "NYPRODUKTION") {
        filtered = filtered.filter(
          (property) =>
            property.is_nyproduktion ||
            property.features?.includes("Nyproduktion") ||
            property.features?.includes("Nybyggd") ||
            property.features?.includes("Nyproducerad") ||
            property.description?.toLowerCase().includes("nyproduktion") ||
            property.description?.toLowerCase().includes("nybyggd"),
        );
    ...
    [properties, filters, countryTab, isSwedishProperty],
  );
  const applyFilters = useCallback(() => {
    ...
    setHasSearched(true);
  }, [properties, filters, activeTab, countryTab, isSwedishProperty]);
        ...
        <div className="w-full lg:w-80">
          <Card>
            ...
            <CardContent className="space-y-6 max-h-[calc(100vh-12rem)] overflow-y-auto">
              {/* AI Smart Search */}
              <div
                className={`bg-accent/10 border border-accent/20 rounded-xl p-4 transition-all duration-300 ${isSearchInputExpanded ? "fixed inset-0 z-50 backdrop-blur-md bg-background/30 flex items-center justify-center" : ""}`}
              >
                ...
                <div
                  className={`relative ${isSearchInputExpanded ? "w-full max-w-4xl mx-auto p-8" : ""}`}
                >
                  ...
                  <p
                    className={`text-xs text-muted-foreground mb-3 ${isSearchInputExpanded ? "text-base" : ""}`}
                  >
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className={`text-sm transition-all duration-300 ${isSearchInputExpanded ? "text-lg p-6" : ""}`}
                    />
                    <Button
                      onClick={() => {
                        handleNaturalSearch();
                ...
                <>
                  <div className="bg-accent/10 border border-accent/20 rounded-xl p-4 space-y-4">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-2">
                        <Input
                          ...
                          onChange={(e) =>
                            updateFilter("minRent", Number(e.target.value) || 0)
                          }
                        />
                        <Input
                          type="number"
                          placeholder="Till"
                          value={
                            filters.maxRent === 50000 ? "" : filters.maxRent
                          }
                          onChange={(e) =>
                            updateFilter(
                              "maxRent",
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-2">
                        {["El", "Värme", "Internet", "Parkering"].map(
                          (utility) => (
                            <div
                              key={utility}
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            updateFilter("petsAllowed", checked)
                          }
                        />
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            updateFilter("shortTerm", checked)
                          }
                        />
                  ...
                  {filters.listingType !== "FOR_RENT" && (
                    <>
                          ...
                          {["ground", "1-3", "4+"].map((level) => {
                            ...
                            return (
                              ...
                              >
                                <Checkbox
                                  id={`floor-${level}`}
                                  checked={filters.floorLevel === level}
                                  onCheckedChange={() =>
                                    updateFilter(
                                      "floorLevel",
                                      filters.floorLevel === level
                                        ? "all"
                                        : level,
                                    )
                                  }
                      ...
                      <div>
                        ...
                        <div className="mt-2 space-y-2">
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id="newconst-yes"
                              checked={filters.isNewConstruction === "yes"}
                              onCheckedChange={() =>
                                updateFilter(
                                  "isNewConstruction",
                                  filters.isNewConstruction === "yes"
                                    ? "all"
                                    : "yes",
                                )
                              }
                          ...
                          <div className="flex items-center space-x-2">
                            <Checkbox
                              id="newconst-no"
                              checked={filters.isNewConstruction === "no"}
                              onCheckedChange={() =>
                                updateFilter(
                                  "isNewConstruction",
                                  filters.isNewConstruction === "no"
                                    ? "all"
                                    : "no",
                                )
                              }
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-2 gap-2 mt-2">
                          <Select
                            ...
                            onValueChange={(value) =>
                              updateFilter("minBuildYear", value)
                            }
                          >
                            <SelectTrigger>
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              updateFilter("maxBuildYear", value)
                            }
                          >
                            <SelectTrigger>
                      ...
                      <div>
                        ...
                        <RadioGroup
                          value={filters.viewingTime}
                          onValueChange={(value) =>
                            updateFilter("viewingTime", value)
                          }
                          className="mt-2 space-y-2"
                        >
                          <div className="flex items-center space-x-2">
                        ...
                        <div className="flex items-center space-x-2 mt-2">
                          <Checkbox
                            ...
                            checked={filters.hideBeforeViewing}
                            onCheckedChange={(checked) =>
                              updateFilter("hideBeforeViewing", checked)
                            }
                          />
                          <Label
                      ...
                      <div>
                        ...
                        <Select
                          value={filters.waterDistance}
                          onValueChange={(value) =>
                            updateFilter("waterDistance", value)
                          }
                        >
                        ...
                        <div className="flex items-center space-x-2 mt-2">
                          <Checkbox
                            id="nearSea"
                            checked={filters.nearSea}
                            onCheckedChange={(checked) =>
                              updateFilter("nearSea", checked)
                            }
                          />
                          <Label
                            htmlFor="nearSea"
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <Checkbox
                    id="hideRental"
                    checked={filters.hideRental}
                    onCheckedChange={(checked) =>
                      updateFilter("hideRental", checked)
                    }
                  />
                  <Label
                    htmlFor="hideRental"
                ...
                <div className="flex items-center gap-2">
                  <Checkbox
                    id="hideCommercial"
                    checked={filters.hideCommercial}
                    onCheckedChange={(checked) =>
                      updateFilter("hideCommercial", checked)
                    }
                  />
                  <Label
                ...
                <div className="flex items-center gap-2">
                  <Checkbox
                    id="hideNyproduktion"
                    checked={filters.hideNyproduktion}
                    onCheckedChange={(checked) =>
                      updateFilter("hideNyproduktion", checked)
                    }
                  />
                  <Label
          ...
          {viewMode !== "map" &&
            (filteredProperties.length === 0 ? (
              ...
              <div className="mx-auto space-y-8">
                {groupPropertiesByDays(filteredProperties).map((group) => (
