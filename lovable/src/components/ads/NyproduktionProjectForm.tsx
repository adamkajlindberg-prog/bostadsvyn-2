...
import { Clock, AlertCircle, CheckCircle, Edit, Send, Calendar, Building2 } from 'lucide-react';
    ...
    try {
      ...
      const { data: adData, error: adError } = await supabase
        ...
        .insert({
          ...
          ad_tier: recommendedPackages.premium ? 'premium' : recommendedPackages.plus ? 'plus' : 'free',
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-warning bg-warning/5">
        <CardContent className="pt-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-warning">Väntande Nyproduktionsprojekt</h3>
              <p className="text-sm text-muted-foreground mt-1">
                Dessa projekt har lagts till via mäklarsystemet och behöver information innan de kan publiceras.
              </p>
            </div>
          </div>
        </CardContent>
      ...
      {selectedProject && (
        <Card>
          <CardHeader>
            <CardTitle>Färdigställ Nyproduktionsprojekt - {selectedProject.title}</CardTitle>
            ...
            <CardDescription>
              Steg {formStep} av 5: {
                formStep === 1 ? 'Projektinformation' :
                formStep === 2 ? 'Rekommenderade paket' :
                formStep === 3 ? 'Säljinformation' :
                formStep === 4 ? 'Betalning & Publicering' :
                'Granska & Skicka'
              }
            </CardDescription>
          </CardHeader>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => setProjectDetails({ ...projectDetails, totalUnits: parseInt(e.target.value) || 0 })}
                    />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="completionDate">Beräknat färdigställande</Label>
                    <Input
                      id="completionDate"
                      type="date"
                      value={projectDetails.completionDate}
                      onChange={(e) => setProjectDetails({ ...projectDetails, completionDate: e.target.value })}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProjectDetails({ ...projectDetails, builderCompany: e.target.value })}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProjectDetails({ ...projectDetails, architectFirm: e.target.value })}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProjectDetails({ ...projectDetails, projectWebsite: e.target.value })}
                  />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="videoUrl">Filmlänk (YouTube, Vimeo, etc.)</Label>
                  <Input
                    id="videoUrl"
                    type="url"
                    ...
                    <div className="flex items-center gap-2 pt-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => 
                          setProjectDetails({ ...projectDetails, videoAsFirstImage: checked as boolean })
                        }
                      />
                      <Label htmlFor="videoAsFirstImage" className="text-sm font-normal cursor-pointer">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setProjectDetails({ ...projectDetails, threedTourUrl: e.target.value })}
                  />
                </div>
              </div>
            )}
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Välj vilket paket du vill rekommendera till säljaren för projektet.
                    </p>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setSellerInfo({ ...sellerInfo, orgNumber: e.target.value })}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setSellerInfo({ ...sellerInfo, notes: e.target.value })}
                  />
                </div>
              </div>
            )}
            ...
            {formStep === 4 && (
              <div className="space-y-6">
                <div className="space-y-4">
                  ...
                  <RadioGroup value={paymentInfo.payer} onValueChange={(value) => setPaymentInfo({ payer: value })}>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="seller" id="payer-seller" />
                      <Label htmlFor="payer-seller" className="font-normal cursor-pointer">
                        Säljaren betalar
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="broker" id="payer-broker" />
                      <Label htmlFor="payer-broker" className="font-normal cursor-pointer">
                ...
                <div className="space-y-4">
                  <Label className="text-base">När ska projektet publiceras?</Label>
                  <RadioGroup value={publishInfo.timing} onValueChange={(value) => setPublishInfo({ ...publishInfo, timing: value })}>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="on_completion" id="timing-completion" />
                      <Label htmlFor="timing-completion" className="font-normal cursor-pointer">
                        Direkt efter godkännande och betalning
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="specific_date" id="timing-specific" />
                      <Label htmlFor="timing-specific" className="font-normal cursor-pointer">
                    ...
                    <div className="grid grid-cols-2 gap-4 pl-6">
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setPublishInfo({ ...publishInfo, specificDate: e.target.value })}
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setPublishInfo({ ...publishInfo, specificTime: e.target.value })}
                        />
                      </div>
                    </div>
                  )}
            ...
            {formStep === 5 && (
              <div className="space-y-6">
                <div className="bg-muted/50 p-6 rounded-lg space-y-4">
                  <h3 className="font-semibold text-lg">Granska projektinformation</h3>
                  
                  <div className="space-y-3">
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">Projektnamn:</span>
                      <p className="font-medium">{projectDetails.projectName}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">Adress:</span>
                      <p className="font-medium">{propertyAddress}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">Antal enheter:</span>
                      <p className="font-medium">{projectDetails.totalUnits} st</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">Paket:</span>
                      <p className="font-medium">
                        {recommendedPackages.premium ? 'Exklusivpaket' : recommendedPackages.plus ? 'Pluspaket' : 'Grundpaket'}
                      </p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">Säljare:</span>
                      <p className="font-medium">{sellerInfo.name} ({sellerInfo.email})</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-muted-foreground">Betalare:</span>
                      <p className="font-medium">{paymentInfo.payer === 'seller' ? 'Säljaren' : 'Mäklarkontoret'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-primary/5 border border-primary/20 rounded-lg p-6">
                  <p className="text-sm text-muted-foreground">
                    När du skickar detta formulär kommer säljaren att få ett e-postmeddelande med länk för att granska och godkänna projektannonsen. Efter godkännande och betalning kommer projektet att publiceras enligt dina inställningar.
                  </p>
                </div>
              </div>
            )}
