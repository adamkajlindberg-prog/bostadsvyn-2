          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="font-medium text-warning">
                Väntande annonser kräver åtgärd
              </h3>
              <p className="text-sm text-muted-foreground mt-1">
                Dessa annonser har lagts till via mäklarsystemet och behöver
                information innan de kan publiceras. Du kommer att få ett mejl
                när en ny annons behöver färdigställas.
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={selectedAd?.address ? "bg-muted" : ""}
                  />
                  <p className="text-xs text-muted-foreground">
                    {selectedAd?.address
                      ? "Adressen hämtades automatiskt från mäklarsystemet"
                      : "Denna adress kommer att visas på annonsen"}
                  </p>
                </div>
                    ...
                    <>
                      <div className="space-y-2">
                        <Label htmlFor="sellerName">
                          {sellerInfo.type === "estate"
                            ? "Organisationsnummer *"
                            : sellerInfo.type === "guardian"
                              ? "God mans namn *"
                              : "Säljarens namn *"}
                        </Label>
                        <Input
                      ...
                      {sellerInfo.type === "private" && (
                        <div className="space-y-2">
                          <Label htmlFor="personalNumber">Personnummer *</Label>
                          <Input
                            id="personalNumber"
                            placeholder="ÅÅÅÅMMDD-XXXX"
                            value={sellerInfo.personalNumber}
                            onChange={(e) =>
                              setSellerInfo({
                                ...sellerInfo,
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="notes"
                    placeholder="Särskilda önskemål eller information från säljaren..."
                    rows={3}
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Välj vilka paket du vill rekommendera till säljaren.
                      Säljaren kan sedan välja sitt önskade paket.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        <Checkbox
                          id="package-free"
                          checked={recommendedPackages.free}
                          onCheckedChange={() => handlePackageSelect("free")}
                        />
                        <div className="flex-1">
                          <Label
                          ...
                          <div className="grid md:grid-cols-2 gap-3 text-xs">
                            <div>
                              ...
                              <ul className="text-muted-foreground space-y-0.5 ml-3">
                                ...
                                <li>
                                  • Tillhörande statistik för mäklare och
                                  säljare
                                </li>
                                <li>
                    ...
                    {/* Pluspaket - 1995 kr */}
                    <div
                      className="border rounded-lg p-4 space-y-3 border-accent/50 bg-accent/5 cursor-pointer hover:bg-accent/10 transition-colors"
                      onClick={() => handlePackageSelect("plus")}
                    >
                      <div className="flex items-start space-x-3">
                        <Checkbox
                          id="package-plus"
                          checked={recommendedPackages.plus}
                          onCheckedChange={() => handlePackageSelect("plus")}
                        />
                        <div className="flex-1">
                          <Label
                            htmlFor="package-plus"
                            className="font-medium cursor-pointer text-lg"
                          >
                            Pluspaket
                          </Label>
                          ...
                          <div className="grid md:grid-cols-2 gap-3 text-xs">
                            <div>
                              ...
                              <ul className="text-muted-foreground space-y-0.5 ml-3">
                                <li>
                                  • Allt som ingår i Grundpaketet + större
                                  annons
                                </li>
                                <li>
                                  • Hamnar över Grundpaketet i
                                  publiceringslistan
                                </li>
                                <li>• Plus-badge</li>
                    ...
                    <div
                      className="border rounded-lg p-4 space-y-3 border-premium/50 bg-premium/5 cursor-pointer hover:bg-premium/10 transition-colors"
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm font-semibold text-premium mt-1">
                            3 995 kr
                          </p>
                          <p className="text-sm text-muted-foreground mb-3">
                ...
                <div className="space-y-2 pt-6 border-t">
                  ...
                  <Textarea
                    ...
                    placeholder="Förklara varför du rekommenderar ett visst paket baserat på objektet och målgruppen..."
                    rows={4}
                    value={brokerRecommendation}
                    onChange={(e) => setBrokerRecommendation(e.target.value)}
                  />
                  <p className="text-xs text-muted-foreground">
                    Denna text kommer att visas för säljaren tillsammans med
                    paketalternativen
                  </p>
                </div>
              </div>
            ...
            {formStep === 3 && (
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    id="headline"
                    placeholder="T.ex. 'Drömvilla vid havet'"
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    {adDetails.headline.length}/20 tecken - Kommer att visas på
                    annonskortet
                  </p>
                  <div className="bg-primary/5 border border-primary/20 p-3 rounded-lg mt-2">
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      <strong>Tips för en bra annonsrubrik:</strong> En kort och
                      kärnfull rubrik fångar uppmärksamhet bäst. Fokusera på det
                      viktigaste - läge, stil eller kännetecken. Exempel:
                      "Havsnära villa" eller "Ljus 3:a i city"
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Länk till film på YouTube, Vimeo eller liknande. Film ökar
                    intresset och ger köpare en bättre känsla för objektet.
                  </p>
                  <p className="text-xs text-muted-foreground leading-relaxed mt-2 p-2 bg-accent/10 rounded-md border border-accent/20">
                    <strong>Tips:</strong> Unikt med Bostadsvyn är att du kan ha
                    en film som förstabild för att fånga mer intresse.
                  </p>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="threedTourUrl">
                    3D-visningslänk (valfritt)
                  </Label>
                  <Input
                    id="threedTourUrl"
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Länk till 3D-visning från Matterport eller liknande tjänst.
                    Ger köpare möjlighet att virtuellt gå igenom objektet.
                  </p>
                </div>

                {adDetails.videoUrl && (
                  <div className="flex items-start space-x-2 bg-accent/5 border border-accent/20 p-3 rounded-lg">
                    <Checkbox
                      id="videoAsFirstImage"
                      checked={adDetails.videoAsFirstImage}
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground mt-1">
                        Filmen startar automatiskt utan ljud när någon hovrar
                        över annonsen. Detta ger maximal uppmärksamhet och
                        synlighet.
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-6">
                ...
                <div className="border-t pt-6 space-y-3">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      {paymentInfo.payer === "seller"
                        ? "Säljarens faktureringsadress hämtas automatiskt från mäklarsystemet"
                        : "Mäklarkontorets faktureringsadress hämtas automatiskt från dina kontouppgifter"}
                    </p>
                  </div>
                    ...
                    {paymentInfo.payer === "seller" ? (
                      <>
                        <div>
                          ...
                          {sellerInfo.name || "Ej angivet"}
                        </div>
                        {sellerInfo.type === "company" &&
                          sellerInfo.orgNumber && (
                            <div>
                    ...
                    <div className="text-sm space-y-1">
                      <p className="font-medium">
                        ...
                        {recommendedPackages.premium &&
                          "Exklusivpaket - 3 995 kr"}
                      </p>
                      <p className="text-muted-foreground">
                        {recommendedPackages.free &&
                          "Grundpaket: Kostnadsfri grundannons för alla"}
                        {recommendedPackages.plus &&
                          "Pluspaket: Större annons med kostnadsfri förnyelse var 4:e vecka"}
                        {recommendedPackages.premium &&
                          "Exklusivpaket: Störst synlighet, unika AI-verktyg och kostnadsfri förnyelse varje månad"}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="border-t pt-6 space-y-3">
                  <Label className="text-base">
                    Säljarens betalningsalternativ
                  </Label>
                  <p className="text-sm text-muted-foreground">
                    Säljaren kommer att kunna välja mellan följande
                    betalningsalternativ när de godkänner annonsen:
                  </p>
                  <div className="bg-muted/50 p-4 rounded-lg space-y-2 text-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-muted-foreground text-xs mt-0.5">
                          Säljaren kan välja att få faktura utskickad efter 3
                          månader
                        </p>
                      </div>
                    </div>
            ...
            {formStep === 5 && (
              <div className="space-y-4">
                <div className="bg-muted p-4 rounded-lg space-y-3">
                  ...
                  {(adDetails.headline || adDetails.videoUrl) && (
                    <div>
                      ...
                      <div className="text-sm space-y-1">
                        ...
                        {adDetails.videoUrl && (
                          <>
                            ...
                            {adDetails.videoAsFirstImage && (
                              <p className="text-muted-foreground">
                                ✓ Filmen visas som förstabild
                              </p>
                            )}
                          </>
                        )}
                  ...
                  <div>
                    ...
                    <div className="text-sm space-y-1">
                      <p>
                        <span className="font-medium">Betalare:</span>{" "}
                        {paymentInfo.payer === "seller"
                          ? "Säljaren"
                          : "Mäklaren"}
                      </p>
                      ...
                      {paymentInfo.payer === "seller" ? (
                        ...
                        <>
                          ...
                          <p className="text-muted-foreground italic">
                            Faktureringsadress från kontouppgifter
                          </p>
                        </>
                      )}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="text-sm space-y-1">
                      <p>
                        ...
                        {publishInfo.timing === "on_completion"
                          ? "När köpet slutförs"
                          : publishInfo.timing === "on_approval"
                            ? "Direkt efter godkännande"
                            : `${new Date(publishInfo.specificDate).toLocaleDateString("sv-SE")} kl. ${publishInfo.specificTime}`}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-primary/5 border border-primary/20 p-4 rounded-lg">
                  ...
                  <ol className="text-sm text-muted-foreground space-y-1 list-decimal list-inside">
                    <li>
                      Säljaren får ett mejl med information angående publicering
                      och paket
                    </li>
            ...
            <div className="flex gap-2 pt-4 border-t">
              ...
              {formStep < 5 ? (
                <Button onClick={() => setFormStep(formStep + 1)}>Nästa</Button>
              ) : (
                <Button onClick={handleCompleteAd} className="gap-2">
