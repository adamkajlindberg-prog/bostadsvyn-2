...
export const SellerAdReview: React.FC<SellerAdReviewProps> = ({
  ...
  const videoUrl =
    property?.video_url ||
    brokerData?.videoUrl ||
    brokerData?.media?.videoUrl ||
    ad.video_url;
  const threedTourUrl =
    property?.threed_tour_url ||
    brokerData?.threedTourUrl ||
    brokerData?.media?.threedTourUrl ||
    ad.threed_tour_url;
  ...
  const _handleReject = async () => {
    try {
      ...
      toast({
        ...
        description:
          "Mäklaren har informerats om att annonsen behöver uppdateras.",
      });
      onRejected();
    } catch (error) {
  ...
  const _getPackageName = (tier: string) => {
    switch (tier) {
      case "premium":
      ...
      <CardContent className="space-y-8 pt-8">
        ...
        <div className="bg-muted/30 rounded-lg p-6 border border-border/50">
          ...
          {ad.description && (
            <div className="mt-6 pt-6 border-t border-border/50">
              ...
              <div>
                <div
                  className={`overflow-hidden transition-all duration-300 ${ad.description.length > 200 ? (expandDescription ? "max-h-[500px]" : "max-h-[80px]") : "max-h-none"}`}
                >
                ...
                {ad.description.length > 200 && (
                  <Button
                    ...
                    className="mt-3 h-9 text-xs font-medium"
                  >
        ...
        <div className="bg-muted/30 rounded-lg p-6 border border-border/50">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              {videoUrl ? (
                <>
                  ...
                  {brokerData.useVideoAsMainImage && (
            ...
            <div className="space-y-2">
              ...
              <p className="text-base font-semibold text-foreground">
                {brokerData.publicationDate
                  ? brokerData.publicationDate
                  : "Publiceras direkt efter godkännande"}
              </p>
            </div>
          </div>
        </div>
        ...
        {brokerData.propertyInfo && (
          <div className="bg-muted/30 rounded-lg p-6 border border-border/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {brokerData.propertyInfo.seller?.name && (
                <div className="space-y-1">
                  <span className="text-xs font-medium text-muted-foreground uppercase tracking-wider">
                    Säljare
                  </span>
              ...
              {brokerData.propertyInfo.seller?.type && (
                <div className="space-y-1">
                  <span className="text-xs font-medium text-muted-foreground uppercase tracking-wider">
                    Typ
                  </span>
                  <p className="text-base font-semibold text-foreground">
                    {brokerData.propertyInfo.seller.type === "private"
                      ? "Privatperson"
                      : "Företag"}
                  </p>
                </div>
        ...
        <div className="bg-muted/30 rounded-lg p-6 border border-border/50">
          ...
          <div className="space-y-6">
            <div className="space-y-1">
              ...
              <p className="text-base font-semibold text-foreground">
                {brokerData.billingInfo?.payer === "seller"
                  ? "Säljare"
                  : brokerData.billingInfo?.payer === "broker"
                    ? "Mäklare"
                    : "Ej angivet"}
              </p>
            </div>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      setEditedBillingAddress(
                        brokerData.billingInfo?.billingAddress || "",
                      );
                    }}
        ...
        <div className="bg-gradient-to-br from-primary/5 to-accent/5 rounded-lg p-6 border-2 border-primary/20">
              ...
              <AccordionTrigger className="px-6 py-5 hover:no-underline">
                <div className="text-left flex-1">
                  <div className="flex items-center gap-3 mb-2 flex-wrap">
                    ...
                    {ad.ad_tier === "premium" && (
                      <Badge className="bg-premium text-premium-foreground shadow-sm">
          ...
          <Button
            ...
            onClick={() => (window.location.href = "/salj")}
          >
        ...
        <div className="flex justify-center pt-6">
          <Button
            ...
            disabled={loading}
            size="lg"
            className="w-full max-w-md h-14 text-base font-bold shadow-lg hover:shadow-xl transition-all"
          >
        ...
        <p className="text-sm text-muted-foreground text-center leading-relaxed max-w-2xl mx-auto">
          Genom att godkänna bekräftar du att informationen är korrekt och att
          annonsen kan publiceras.
        </p>
      </CardContent>
    </Card>
  );
