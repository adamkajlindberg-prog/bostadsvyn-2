...
const AIMarketAnalysis = () => {
  ...
  const [analysisResult, setAnalysisResult] = useState<MarketInsights | null>(
    null,
  );
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const result: MarketInsights = {
        ...
        marketTrend: {
          direction: (aiAnalysis.marketTrend?.direction ||
            aiAnalysis.market_trend?.direction ||
            "stable") as "up" | "down" | "stable",
          percentage:
            aiAnalysis.marketTrend?.percentage ||
            aiAnalysis.market_trend?.percentage ||
            0,
          description:
            aiAnalysis.marketTrend?.description ||
            aiAnalysis.market_trend?.description ||
            "Stabil marknadsutveckling",
        },
        demandSupply: {
          demand:
            aiAnalysis.demandSupply?.demand ||
            aiAnalysis.demand_supply?.demand ||
            50,
          supply:
            aiAnalysis.demandSupply?.supply ||
            aiAnalysis.demand_supply?.supply ||
            50,
          ratio:
            aiAnalysis.demandSupply?.ratio ||
            aiAnalysis.demand_supply?.ratio ||
            1,
          status: (aiAnalysis.demandSupply?.status ||
            aiAnalysis.demand_supply?.status ||
            "balanced") as "sellers_market" | "buyers_market" | "balanced",
        },
        averageDaysOnMarket:
          aiAnalysis.averageDaysOnMarket ||
          aiAnalysis.average_days_on_market ||
          aiAnalysis.daysOnMarket ||
          30,
        ...
        predictions: {
          next3Months:
            aiAnalysis.predictions?.next3Months ||
            aiAnalysis.predictions?.three_months ||
            0,
          next6Months:
            aiAnalysis.predictions?.next6Months ||
            aiAnalysis.predictions?.six_months ||
            0,
          next12Months:
            aiAnalysis.predictions?.next12Months ||
            aiAnalysis.predictions?.twelve_months ||
            0,
        ...
        <div className="text-center space-y-4">
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-muted-foreground">
              {marketData.area} - {marketData.propertyType}
            </span>
          </div>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-foreground">
                    {analysisResult.averageDaysOnMarket}
                  </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-orange-900">
                    {analysisResult.demandSupply.ratio.toFixed(1)}
                  </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold text-purple-900">
                    {analysisResult.predictions.confidence}%
                  </p>
                  ...
                  <LineChart data={analysisResult.priceData}>
                    ...
                    <Tooltip
                      formatter={(value, name) => [
                        ...
                        name === "avgPrice" ? "Genomsnittspris" : "Medianpris",
                      ]}
                    />
                    <Legend />
                    <Line
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center p-4 border rounded-lg">
                    <p className="text-2xl font-bold text-green-600">
                      +{analysisResult.predictions.next3Months}%
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Nästa 3 månader
                    </p>
                  ...
                  <div className="text-center p-4 border rounded-lg">
                    <p className="text-2xl font-bold text-primary">
                      +{analysisResult.predictions.next6Months}%
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Nästa 6 månader
                    </p>
                  ...
                  <div className="text-center p-4 border rounded-lg">
                    <p className="text-2xl font-bold text-purple-600">
                      +{analysisResult.predictions.next12Months}%
                    </p>
                    <p className="text-sm text-muted-foreground">
                      Nästa 12 månader
                    </p>
                ...
                <div className="mt-6 p-4 bg-muted rounded-lg">
                  <p className="text-sm text-muted-foreground">
                    Prognoserna baseras på historiska data, aktuella
                    marknadstrender och ekonomiska indikatorer. Säkerhetsnivå:{" "}
                    {analysisResult.predictions.confidence}%
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {analysisResult.hotspots.map((hotspot, index) => (
                    <div
                      key={index}
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            onClick={runAnalysis}
            disabled={loading || !marketData.area || !marketData.propertyType}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="border-primary/20 bg-nordic-ice">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="font-semibold text-foreground">Pristrender</h3>
            <p className="text-sm text-muted-foreground">
              Historiska och framtida prisutvecklingar
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="font-semibold text-green-900">Prognoser</h3>
            <p className="text-sm text-green-700">
              AI-baserade marknadsförutsägelser
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-orange-200 bg-orange-50">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="font-semibold text-orange-900">Hotspots</h3>
            <p className="text-sm text-orange-700">
              Områden med stark tillväxtpotential
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="border-purple-200 bg-purple-50">
          <CardContent className="p-4 text-center">
            ...
            <h3 className="font-semibold text-purple-900">Utbud/Efterfrågan</h3>
            <p className="text-sm text-purple-700">
              Marknadsbalans och köp-/säljsignaler
            </p>
          </CardContent>
        </Card>
      </div>
