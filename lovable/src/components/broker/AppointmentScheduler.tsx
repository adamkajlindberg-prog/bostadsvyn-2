...
export const AppointmentScheduler: React.FC = () => {
      ...
      const mockAppointments: Appointment[] = [
        {
          ...
          notes:
            "Klienten är särskilt intresserad av balkongen och ljusinsläppet.",
        ...
        },
        {
          ...
          notes:
            "Klienten vill sälja inom 6 månader. Villa från 1985, renoverad 2020.",
          created_at: new Date().toISOString(),
          reminder_sent: false,
        },
        {
  ...
  const getAppointmentsForDate = (date: Date) => {
    return appointments
      .filter((apt) => isSameDay(parseISO(apt.scheduled_at), date))
      .sort(
        (a, b) =>
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Dialog
            open={isCreatingAppointment}
            onOpenChange={setIsCreatingAppointment}
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    {format(
                      parseISO(selectedAppointment.scheduled_at),
                      "dd MMM yyyy HH:mm",
                      { locale: sv },
                    )}
                  </span>
