        ...
        <div className="flex items-center gap-6">
          <div className="relative">
            ...
            <label
              ...
              className="absolute bottom-0 right-0 p-2 bg-primary text-primary-foreground rounded-full cursor-pointer hover:bg-primary-deep transition-colors"
            >
              {isUploading ? (
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Fastighetsmäklare som publicerar annonser på Bostadsvyn kan ladda
              upp en profilbild som kommer att synas i annonserna tillsammans
              med namn och mäklarfirma. Profilbilden ska vara utan logotyp.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Berätta om dig själv, din erfarenhet och specialisering..."
              rows={6}
