...
export function MarketShareContent() {
  ...
  const [_showDevelopers, _setShowDevelopers] = useState(false);
  const [_showNewConstruction, _setShowNewConstruction] = useState<
    "hide" | "show" | "only"
  >("hide");
  const [_showCondos, _setShowCondos] = useState<"hide" | "show">("show");
                ...
                <div className="flex gap-2 flex-wrap">
                  {(
                    ...
                    <Button
                      ...
                      size="sm"
                      variant={
                        statusFilters.includes(status) ? "default" : "outline"
                      }
