...
const LogoVariant30: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      <g fill="currentColor">
        ...
        <path d="M20 8 L32 2 L44 8" fill="none" stroke="currentColor" strokeWidth="3" />
      </g>
