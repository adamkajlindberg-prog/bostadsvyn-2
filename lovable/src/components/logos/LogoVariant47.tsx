...
const LogoVariant47: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      {/* Höger sida (mörkare) */}
      <path d="M32 16 L48 24 L48 48 L32 56 Z" fill="currentColor" opacity="0.25" />
      
      {/* Vänster sida (ljusare) */}
      <path d="M16 24 L32 16 L32 56 L16 48 Z" fill="url(#wallGrad47)" />
      
      {/* Framsida med B */}
      <path d="M16 24 L32 32 L48 24 L48 48 L32 56 L16 48 Z" fill="currentColor" opacity="0.2" />
      
      {/* Takterrass - topp */}
      <path d="M20 20 L32 14 L44 20 L32 26 Z" fill="url(#roofGrad47)" />
      
      {/* Takterrass - sidor */}
      <path d="M20 20 L20 24 L32 30 L32 26 Z" fill="currentColor" opacity="0.35" />
      <path d="M32 26 L32 30 L44 24 L44 20 Z" fill="currentColor" opacity="0.5" />
      ...
      <g fill="currentColor" opacity="0.4">
        <rect x="20" y="34" width="4" height="4" rx="0.5" transform="skewY(-10)" />
        <rect x="20" y="42" width="4" height="4" rx="0.5" transform="skewY(-10)" />
      </g>
    </svg>
  );
};
