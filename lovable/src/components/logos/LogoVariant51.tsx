...
const LogoVariant51: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      <path d="M10 32 L32 22 L32 58 L10 48 Z" fill="currentColor" opacity="0.28" />
      <path d="M32 22 L54 32 L54 48 L32 58 Z" fill="currentColor" opacity="0.22" />
      
      <path d="M8 28 L32 16 L56 28 L32 40 Z" fill="currentColor" opacity="0.55" />
      <path d="M8 28 L8 32 L32 44 L32 40 Z" fill="currentColor" opacity="0.4" />
      <path d="M32 40 L32 44 L56 32 L56 28 Z" fill="currentColor" opacity="0.5" />
