...
const LogoVariant56: React.FC<LogoProps> = ({
  className = "h-10 w-10",
  ...
  return (
    ...
    >
      ...
      <path
        d="M14 26 L32 16 L32 54 L14 44 Z"
        fill="currentColor"
        opacity="0.3"
      />
      <path
        d="M32 16 L50 26 L50 44 L32 54 Z"
        fill="currentColor"
        opacity="0.24"
      />

      <path
        d="M18 22 L32 14 L46 22 L32 30 Z"
        fill="currentColor"
        opacity="0.56"
      />
      <path
        d="M18 22 L18 26 L32 34 L32 30 Z"
        fill="currentColor"
        opacity="0.42"
      />
      <path
        d="M32 30 L32 34 L46 26 L46 22 Z"
        fill="currentColor"
        opacity="0.56"
      />
