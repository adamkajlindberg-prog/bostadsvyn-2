...
const LogoVariant58: React.FC<LogoProps> = ({
  className = "h-10 w-10",
  ...
  return (
    ...
    >
      ...
      <path
        d="M20 26 L32 20 L44 26 L32 32 Z"
        fill="currentColor"
        opacity="0.52"
      />
      <path
        d="M20 26 L20 30 L32 36 L32 32 Z"
        fill="currentColor"
        opacity="0.4"
      />
      <path
        d="M32 32 L32 36 L44 30 L44 26 Z"
        fill="currentColor"
        opacity="0.52"
      />

      <path
        d="M24 32 L32 28 L40 32 L32 36 Z"
        fill="currentColor"
        opacity="0.46"
      />
