...
const LogoVariant61: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      <path d="M22 24 L32 18 L50 26 L32 34 Z" fill="currentColor" opacity="0.54" />
      <path d="M22 24 L22 28 L32 34 Z" fill="currentColor" opacity="0.4" />
      <path d="M32 34 L32 38 L50 30 L50 26 Z" fill="currentColor" opacity="0.54" />
