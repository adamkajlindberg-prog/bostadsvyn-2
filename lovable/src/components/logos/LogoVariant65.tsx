...
const LogoVariant65: React.FC<LogoProps> = ({
  className = "h-10 w-10",
  ...
  return (
    ...
    >
      ...
      <path
        d="M8 32 L32 20 L32 60 L8 52 Z"
        fill="currentColor"
        opacity="0.35"
      />
      <path
        d="M32 20 L56 32 L56 52 L32 60 Z"
        fill="currentColor"
        opacity="0.28"
      />
      ...
      />
      <path
        d="M12 28 L12 32 L32 42 L32 38 Z"
        fill="currentColor"
        opacity="0.45"
      />
      <path
        d="M32 38 L32 42 L52 32 L52 28 Z"
        fill="currentColor"
        opacity="0.58"
      />
