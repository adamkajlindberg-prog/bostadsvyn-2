...
const LogoVariant66: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      <path d="M14 26 L14 30 L32 38 L32 34 Z" fill="currentColor" opacity="0.38" />
      <path d="M32 34 L32 38 L50 30 L50 26 Z" fill="currentColor" opacity="0.5" />
