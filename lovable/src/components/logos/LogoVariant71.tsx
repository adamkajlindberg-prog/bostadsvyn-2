...
const LogoVariant71: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      <g>
        ...
        {/* Fönster */}
        <rect x="27" y="20" width="2" height="3" fill="currentColor" opacity="0.4" />
        <rect x="33" y="20" width="2" height="3" fill="currentColor" opacity="0.4" />
      </g>
      ...
      <g>
        ...
        {/* Fönster och dörr */}
        <rect x="27" y="38" width="2" height="3" fill="currentColor" opacity="0.4" />
        <rect x="33" y="38" width="2" height="3" fill="currentColor" opacity="0.4" />
        <rect x="29" y="42" width="3" height="5" fill="currentColor" opacity="0.4" />
      </g>
    </svg>
  );
};
