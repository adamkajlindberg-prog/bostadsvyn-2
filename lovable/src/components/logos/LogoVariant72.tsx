...
const LogoVariant72: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      {/* Mittenlinje i B */}
      <line x1="16" y1="32" x2="46" y2="32" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" />
