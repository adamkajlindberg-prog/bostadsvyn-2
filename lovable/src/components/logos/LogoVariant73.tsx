...
const LogoVariant73: React.FC<LogoProps> = ({
  className = "h-10 w-10",
  ...
  return (
    ...
    >
      ...
      <path
        d="M8 34 L32 24 L32 62 L8 52 Z"
        fill="currentColor"
        opacity="0.25"
      />
      <path
        d="M32 24 L56 34 L56 52 L32 62 Z"
        fill="currentColor"
        opacity="0.2"
      />
      ...
      <path
        d="M12 30 L32 22 L52 30 L32 38 Z"
        fill="currentColor"
        opacity="0.6"
      />
      <path
        d="M12 30 L12 34 L32 42 L32 38 Z"
        fill="currentColor"
        opacity="0.45"
      />
      <path
        d="M32 38 L32 42 L52 34 L52 30 Z"
        fill="currentColor"
        opacity="0.6"
      />
