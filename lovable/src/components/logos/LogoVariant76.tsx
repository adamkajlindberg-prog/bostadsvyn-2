...
const LogoVariant76: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      {/* Övre takterrass */}
      <path d="M16 26 L32 20 L48 26 L32 32 Z" fill="currentColor" opacity="0.62" />
      <path d="M16 26 L16 29 L32 35 L32 32 Z" fill="currentColor" opacity="0.46" />
      <path d="M32 32 L32 35 L48 29 L48 26 Z" fill="currentColor" opacity="0.62" />
      
      {/* Undre takterrass */}
      <path d="M14 30 L32 24 L50 30 L32 36 Z" fill="currentColor" opacity="0.54" />
      <path d="M14 30 L14 33 L32 39 L32 36 Z" fill="currentColor" opacity="0.4" />
      <path d="M32 36 L32 39 L50 33 L50 30 Z" fill="currentColor" opacity="0.54" />
