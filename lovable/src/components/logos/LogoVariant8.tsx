...
const LogoVariant8: React.FC<LogoProps> = ({ className = 'h-10 w-10', title = 'Bostadsvyn logotyp' }) => {
  ...
  return (
    ...
    >
      ...
      <text x="32" y="44" textAnchor="middle" fontSize="28" fontWeight="800" fill="currentColor" fontFamily="system-ui, sans-serif" opacity="0.95">B</text>
