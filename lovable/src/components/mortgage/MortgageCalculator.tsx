...
export default function MortgageCalculator() {
  ...
  const calculateMortgage = () => {
    ...
    const currentBank =
      BANK_SCENARIOS[selectedBank as keyof typeof BANK_SCENARIOS];
    const rate =
      currentBank.rates[selectedRateType as keyof typeof currentBank.rates] /
      100 /
      12;
    ...
    const monthlyInterest =
      ...
      (currentBank.rates[selectedRateType as keyof typeof currentBank.rates] /
        100 /
        12);
    const taxDeduction = monthlyInterest * 0.3; // 30% tax deduction on interest
  ...
  const calculateAffordability = () => {
    ...
    const maxAffordablePayment = Math.min(availableIncome * 0.8, income * 0.3);

    // Calculate max affordable property price
    const rate = calculation.interestRate / 100 / 12;
    const months = calculation.loanTerm * 12;
    const maxLoanAmount =
      (maxAffordablePayment * ((1 + rate) ** months - 1)) /
      (rate * (1 + rate) ** months);
  ...
  const performStressTest = () => {
    ...
    const stressedPayment =
      (loanAmount * (stressRate * (1 + stressRate) ** months)) /
      ((1 + stressRate) ** months - 1);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription className="mt-1">
                  Beräkna månadsavgift, totalkostnad och stresstest enligt
                  svenska bankers kriterier
                </CardDescription>
              </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Jämför ränteerbjudanden från olika banker eller olika
                    marknadsscenarier
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updatePropertyPrice(Number(e.target.value))
                    }
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between text-xs text-muted-foreground">
                    <span className="font-medium">
                      Min:{" "}
                      {(calculation.propertyPrice * 0.15).toLocaleString(
                        "sv-SE",
                      )}{" "}
                      kr (15%)
                    </span>
                    <span className="font-semibold">
                      Aktuell:{" "}
                      {(
                        (calculation.downPayment / calculation.propertyPrice) *
                        100
                      ).toFixed(1)}
                      %
                    </span>
                  ...
                  >
                    ...
                    <SelectContent>
                      {(() => {
                        const currentBank =
                          BANK_SCENARIOS[
                            selectedBank as keyof typeof BANK_SCENARIOS
                          ];
                        return (
                          <>
                            <SelectItem value="variable">
                              Rörlig ränta - {currentBank.rates.variable}%
                            </SelectItem>
                            <SelectItem value="1_year">
                              1 år - {currentBank.rates["1_year"]}%
                            </SelectItem>
                            <SelectItem value="2_year">
                              2 år - {currentBank.rates["2_year"]}%
                            </SelectItem>
                            <SelectItem value="3_year">
                              3 år - {currentBank.rates["3_year"]}%
                            </SelectItem>
                            <SelectItem value="5_year">
                              5 år - {currentBank.rates["5_year"]}%
                            </SelectItem>
                          </>
                        );
                      })()}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4">
                    <Slider
                      ...
                      onValueChange={([value]) =>
                        setCalculation((prev) => ({ ...prev, loanTerm: value }))
                      }
                      max={50}
                      min={5}
                      step={5}
              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 rounded-lg bg-primary/5 border border-primary/20">
                    ...
                    <p className="price-text text-primary">
                      {calculation.monthlyPayment.toLocaleString("sv-SE", {
                        maximumFractionDigits: 0,
                      })}{" "}
                      kr
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Månadsavgift (före skatt)
                    </p>
                  </div>
                  ...
                  <div className="text-center p-4 rounded-lg bg-success/5 border border-success/20">
                    ...
                    <p className="price-text text-success">
                      {calculation.monthlyAfterTax.toLocaleString("sv-SE", {
                        maximumFractionDigits: 0,
                      })}{" "}
                      kr
                    </p>
                    <p className="text-xs text-muted-foreground">
                      Månadsavgift (efter skatt)
                    </p>
                  </div>
                </div>
                ...
                {includeRunningCosts && (
                  <div className="text-center p-6 rounded-lg bg-gradient-to-br from-accent/10 to-accent/5 border-2 border-accent/30">
                    ...
                    <p className="price-text text-accent mb-1">
                      {getTotalMonthlyCost().toLocaleString("sv-SE", {
                        maximumFractionDigits: 0,
                      })}{" "}
                      kr
                    </p>
                    <p className="property-type-text text-muted-foreground">
                      Total månadsavgift (inkl. drift)
                    </p>
                  </div>
                )}
                ...
                <div className="p-4 rounded-lg bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h4 className="property-type-text mb-1">
                        Klar att ansöka?
                      </h4>
                      <p className="text-xs text-muted-foreground mb-3">
                        Ansök om lånelöfte hos våra samarbetsbanker för att se
                        exakta erbjudanden
                      </p>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="property-type-text">
                      {calculation.loanAmount.toLocaleString("sv-SE")} kr
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="property-type-text">
                      {calculation.totalInterest.toLocaleString("sv-SE")} kr
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="property-type-text">
                      {calculation.totalCost.toLocaleString("sv-SE")} kr
                    </span>
                  </div>
                </div>
                ...
                {calculation.loanToValue > 85 && (
                  <div className="flex items-start gap-2 p-3 rounded-lg bg-critical/5 border border-critical/20">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        Belåningsgrad över 85% kan kräva högre ränta eller
                        amorteringskrav
                      </p>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {affordability.maxAffordablePayment.toLocaleString(
                        "sv-SE",
                        { maximumFractionDigits: 0 },
                      )}{" "}
                      kr
            ...
            <Card className="shadow-card">
              <CardHeader>
                <CardTitle className="text-lg">
                  Betalningsförmågeanalys
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center p-4 rounded-lg bg-muted/50">
                  <div
                    className={`text-3xl font-bold ${getAffordabilityColor(
                      affordability.debtToIncomeRatio < 25
                        ? "good"
                        : affordability.debtToIncomeRatio < 30
                          ? "acceptable"
                          : "risky",
                    )}`}
                  >
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold">
                      {affordability.maxAffordablePrice.toLocaleString(
                        "sv-SE",
                        { maximumFractionDigits: 0 },
                      )}{" "}
                      kr
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={`font-semibold ${
                        affordability.maxAffordablePayment >
                        getTotalMonthlyCost()
                          ? "text-success"
                          : "text-critical"
                      }`}
          ...
          <Card className="shadow-card">
            <CardHeader>
              ...
              <p className="text-muted-foreground">
                Beräkning med {STRESS_TEST_RATE}% ränta enligt
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="text-center p-4 rounded-lg bg-muted/50">
                  <p className="text-lg font-bold">
                    {stressTest.currentPayment.toLocaleString("sv-SE", {
                      maximumFractionDigits: 0,
                    })}{" "}
                    kr
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Nuvarande månadsavgift
                  </p>
                  <p className="text-xs text-muted-foreground">
                    ({calculation.interestRate.toFixed(2)}% ränta)
                  </p>
                </div>

                <div className="text-center p-4 rounded-lg bg-warning/5 border border-warning/20">
                  <p className="text-lg font-bold text-warning">
                    {stressTest.stressedPayment.toLocaleString("sv-SE", {
                      maximumFractionDigits: 0,
                    })}{" "}
                    kr
                  </p>
                ...
                <div className="text-center p-4 rounded-lg bg-critical/5 border border-critical/20">
                  <p className="text-lg font-bold text-critical">
                    +
                    {stressTest.difference.toLocaleString("sv-SE", {
                      maximumFractionDigits: 0,
                    })}{" "}
                    kr
                  </p>
                  ...
                  <p className="text-xs text-muted-foreground">
                    (+
                    {(stressTest.difference * 12).toLocaleString("sv-SE", {
                      maximumFractionDigits: 0,
                    })}{" "}
                    kr/år)
                  </p>
                  ...
                  <p className="font-semibold">
                    ...
                    <span
                      className={getAffordabilityColor(
                        stressTest.affordability,
                      )}
                    >
                      {stressTest.affordability === "good"
                        ? "Godkänd"
                        : stressTest.affordability === "acceptable"
                          ? "Acceptabel"
                          : "Riskabel"}
                    </span>
                  </p>
                  <p className="text-sm text-muted-foreground">
                    Skuldsättningsgrad vid stresstest:{" "}
                    {(
                      (stressTest.stressedPayment /
                        affordability.monthlyIncome) *
                      100
                    ).toFixed(1)}
                    %
                  ...
                  {[5, 6, 7, 8].map((rate) => {
                    ...
                    const payment =
                      (calculation.loanAmount *
                        (rateMonthly * (1 + rateMonthly) ** months)) /
                      ((1 + rateMonthly) ** months - 1);
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {Object.entries(
                      ...
                      const totalInterest =
                        payment * months - calculation.loanAmount;
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="p-3 property-type-text">
                            {rate.toFixed(2)}%
                          </td>
                          <td className="p-3 property-type-text">
                            {payment.toLocaleString("sv-SE", {
                          ...
                          <td className="p-3 font-medium">
                            {totalInterest.toLocaleString("sv-SE", {
                              maximumFractionDigits: 0,
                            })}{" "}
                            kr
                          </td>
