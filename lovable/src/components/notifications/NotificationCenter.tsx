...
interface Notification {
  id: string;
  user_id: string;
  type: 'property_match' | 'price_change' | 'new_message' | 'viewing_scheduled' | 'market_update' | 'system';
  title: string;
  message: string;
  is_read: boolean;
...
export default function NotificationCenter() {
      ...
      const mockNotifications: Notification[] = [
        {
          ...
          message: 'En 3:a i Stockholm för 4 500 000 kr har lagts upp som matchar din sparade sökning "Lägenhet Stockholm".',
          is_read: false,
          priority: 'high',
        ...
        },
        {
          ...
          message: 'Priset på "Mysig 2:a i Södermalm" har sänkts med 200 000 kr.',
          is_read: false,
          priority: 'medium',
        ...
        },
        {
          ...
          message: 'Din visning av "Villa med havsutsikt" är bekräftad för imorgon kl 15:00.',
          is_read: true,
          priority: 'high',
        ...
        },
        {
          ...
          message: 'Nya prisstatistik visar 2,3% ökning i ditt bevakade område.',
          is_read: true,
          priority: 'low',
  ...
  const getNotificationIcon = (type: string) => {
    switch (type) {
      case 'property_match': return <Home className="h-4 w-4 text-blue-500" />;
      case 'price_change': return <TrendingUp className="h-4 w-4 text-green-500" />;
      case 'new_message': return <MessageSquare className="h-4 w-4 text-purple-500" />;
      case 'viewing_scheduled': return <Calendar className="h-4 w-4 text-orange-500" />;
      case 'market_update': return <AlertCircle className="h-4 w-4 text-info" />;
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Direktnotifieringar i webbläsaren</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">När nya fastigheter matchar dina sökningar</p>
                    </div>
                  </div>
                  <Switch
                    checked={settings.property_matches}
                    onCheckedChange={(checked) => updateSettings('property_matches', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">När priser ändras på bevakade fastigheter</p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Nya meddelanden från mäklare</p>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Bekräftelser och påminnelser om visningar</p>
                    </div>
                  </div>
                  <Switch
                    checked={settings.viewings}
                    onCheckedChange={(checked) => updateSettings('viewings', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Nyheter och trender från fastighetsmarknaden</p>
                    </div>
                  </div>
                  <Switch
                    checked={settings.market_updates}
                    onCheckedChange={(checked) => updateSettings('market_updates', checked)}
                  />
                </div>
              </div>
            </div>
