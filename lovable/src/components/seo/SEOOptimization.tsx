...
export default function SEOOptimization({
  ...
  const fullTitle = title.includes("Bostadsvyn")
    ? title
    : `${title} | Bostadsvyn`;
  ...
  return (
    <Helmet>
      ...
      <link
        rel="dns-prefetch"
        href="https://evgzebvzrihsqfqhmwxo.supabase.co"
      />
...
export const generateOrganizationStructuredData = () => {
  return {
    ...
    description:
      "Sveriges modernaste fastighetsplattform med AI-drivna verktyg för köpare, säljare och mäklare.",
    address: {
      "@type": "PostalAddress",
      addressCountry: "SE",
    },
