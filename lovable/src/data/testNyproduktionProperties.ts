...
export const TEST_NYPRODUKTION_PROPERTIES: Property[] = [
  {
    ...
    features: ['Nyproduktion', 'Balkong', 'Hiss', 'Tvättstuga', 'Förråd', 'Cykelrum'],
  ...
  },
  {
    ...
    features: ['Nyproduktion', 'Bergvärme', 'Solceller', 'Parkering', 'Uteplats', 'Nära tåg'],
    created_at: new Date().toISOString(),
    user_id: 'test-user',
    ad_tier: 'premium',
  ...
  },
  {
    ...
    features: ['Nyproduktion', 'Takterrass 80kvm', 'Panoramautsikt', '2 Parkeringar', 'Förråd', 'Lyxstandard'],
    created_at: new Date().toISOString(),
    user_id: 'test-user',
    ad_tier: 'premium',
    tenure_type: 'CONDOMINIUM'
  },
  {
    ...
    features: ['Nyproduktion', 'Smart home', 'Bergvärme', 'Solceller', 'Garage', 'Havsnära'],
    created_at: new Date().toISOString(),
    user_id: 'test-user',
    ad_tier: 'premium',
    tenure_type: 'OWNERSHIP'
  ...
  },
  {
    ...
    features: ['Nyproduktion', 'Stor trädgård', 'Carport', 'Bergvärme', 'Barnvänligt', 'Förskola 200m'],
    created_at: new Date().toISOString(),
    user_id: 'test-user',
    ad_tier: 'premium',
    tenure_type: 'OWNERSHIP'
  },
  {
    ...
    features: ['Nyproduktion', 'Älvutsikt', 'Balkong', 'Centralt läge', 'Hiss', 'Gym i huset'],
    created_at: new Date().toISOString(),
    user_id: 'test-user',
    ad_tier: 'plus',
    tenure_type: 'CONDOMINIUM'
  },
  {
    ...
    features: ['Nyproduktion', 'Concierge', 'Pool', 'Bastu', 'Gym', '2 Parkeringar', 'Vinförråd'],
    created_at: new Date().toISOString(),
    user_id: 'test-user',
    ad_tier: 'premium',
    tenure_type: 'CONDOMINIUM'
  },
  {
    ...
    features: ['Nyproduktion', 'Sjöutsikt', 'Egen brygga', 'Takterrass', 'Garage', 'Smart home'],
    created_at: new Date().toISOString(),
    user_id: 'test-user',
    ad_tier: 'premium',
    tenure_type: 'OWNERSHIP'
  },
  {
    ...
    features: ['Nyproduktion', 'Nära universitet', 'Smart inredning', 'Cykelrum', 'Tvättstuga'],
    created_at: new Date().toISOString(),
    user_id: 'test-user',
    ad_tier: 'free',
    tenure_type: 'CONDOMINIUM'
