...
import { Download, TrendingUp, TrendingDown, Home, Building2, Award, ArrowLeft } from 'lucide-react';
      ...
      <div className="flex">
        ...
        <aside className="w-80 border-r bg-gradient-to-b from-card to-muted/20 p-6 h-screen overflow-y-auto sticky top-0">
          ...
          <div className="mb-6">
            ...
            <p className="text-xs text-muted-foreground">Anpassa din marknadsanalys</p>
          </div>
          ...
          <Accordion type="multiple" defaultValue={["type", "area", "price"]} className="space-y-2">
            ...
            {/* Avancerade filter */}
            <AccordionItem value="advanced" className="border rounded-lg px-4 bg-card">
              <AccordionTrigger className="hover:no-underline">
                <div className="flex items-center gap-2">
                  <Building2 className="h-4 w-4" />
              ...
              <AccordionContent className="pt-4 pb-2 space-y-4">
                <div>
                  <Label className="text-xs text-muted-foreground mb-2 block">Bostadsutvecklare</Label>
                ...
                <div>
                  <Label className="text-xs text-muted-foreground mb-2 block">Nyproduktion</Label>
                  <div className="flex gap-2">
                    <Button
                      size="sm"
                      variant={showNewConstruction === 'hide' ? "default" : "outline"}
                    ...
                    <Button
                      size="sm"
                      variant={showNewConstruction === 'show' ? "default" : "outline"}
                    ...
                    <Button
                      size="sm"
                      variant={showNewConstruction === 'only' ? "default" : "outline"}
                ...
                <div>
                  <Label className="text-xs text-muted-foreground mb-2 block">Andelsboenden</Label>
                  <div className="flex gap-2">
                    <Button
                      size="sm"
