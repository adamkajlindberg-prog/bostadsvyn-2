  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOOptimization
        ...
        description="Bostadsvyn Sverige AB grundades 2025 med visionen att utveckla en modern fastighetsplattform. Lär dig mer om våra värderingar, mål och vad som gör oss unika."
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-foreground font-medium max-w-4xl mx-auto leading-relaxed">
            Vi erbjuder en modern fastighetsplattform som kombinerar
            AI-teknologi med användarvänlig design för att förenkla och
            förbättra sökandet efter bostad för alla.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          <Card className="border-2 border-primary/20 hover:border-primary/40 transition-all">
            ...
            <CardContent>
              <p className="text-foreground leading-relaxed mb-4">
                Vi revolutionerar fastighetsmarknaden genom att förena avancerad
                teknologi med djup branschkunskap. Vårt mål är att skapa en
                transparent, effektiv och användarvänlig plattform som förenklar
                hela fastighetsprocessen.
              </p>
              <p className="text-foreground leading-relaxed">
                Med fokus på tillgänglighet och kvalitet levererar vi
                professionella verktyg och beslutsunderlag för privatpersoner,
                företag och fastighetsmäklare – oavsett om det gäller köp,
          ...
          <Card className="border-2 border-accent/20 hover:border-accent/40 transition-all">
            ...
            <CardContent>
              <p className="text-foreground leading-relaxed mb-4">
                Att bli den ledande fastighetsplattformen i Sverige genom att
                sätta nya standarder för användarvänlighet, transparens och
                professionalism. Vi skapar ett ekosystem där alla parter –
                köpare, säljare, mäklare och hyresvärdar – får tillgång till
                samma högkvalitativa verktyg och information.
              </p>
              <p className="text-foreground leading-relaxed">
                Genom kontinuerlig innovation och nära kontakt med branschen
                bygger vi framtidens fastighetsmarknad – en marknad som är mer
                rättvis, effektiv och tillgänglig för alla.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-foreground max-w-3xl mx-auto text-lg">
              Vi bygger en fastighetsplattform med moderna verktyg och
              funktioner. Här är våra huvudsakliga fokusområden och planerade
              funktioner.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <Card className="border-2 border-accent/20 hover:border-accent/40 transition-all">
              <CardContent className="p-6">
                ...
                <p className="text-foreground text-sm leading-relaxed mb-3">
                  Vi arbetar för att erbjuda olika typer av bostäder på en och
                  samma plattform - från villor och lägenheter till
                  hyresbostäder och kommersiella fastigheter.
                </p>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary" className="text-xs">
                    Flera fastighetstyper
                  </Badge>
                  <Badge variant="secondary" className="text-xs">
                    Rikstäckande
                  </Badge>
            ...
            <Card className="border-2 border-primary/20 hover:border-primary/40 transition-all">
              <CardContent className="p-6">
                ...
                <p className="text-foreground text-sm leading-relaxed mb-3">
                  Vi utvecklar AI-verktyg för bildredigering, homestyling och
                  marknadsanalys som ska ge användare bättre beslutsunderlag för
                  sina fastighetsaffärer.
                </p>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary" className="text-xs">
                    AI-verktyg
            ...
            <Card className="border-2 border-success/20 hover:border-success/40 transition-all">
              <CardContent className="p-6">
                ...
                <p className="text-foreground text-sm leading-relaxed mb-3">
                  BankID-verifiering, GDPR-efterlevnad, manuell moderering av
                  annonser och digitala avtal med juridisk säkerhet för alla
                  transaktioner.
                </p>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary" className="text-xs">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-foreground max-w-2xl mx-auto">
              Din säkerhet och integritet är vår högsta prioritet. Vi följer
              alla relevanta lagar och arbetar kontinuerligt för att skydda dina
              uppgifter.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <Card className="border-success/30">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-foreground leading-relaxed">
                  Vi använder svenskt BankID för användarverifiering för att öka
                  säkerheten och motverka bedrägerier på plattformen.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-premium/30">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-foreground leading-relaxed">
                  Vi efterlever GDPR-regelverket och arbetar för att skydda
                  användarnas personuppgifter med krypterad lagring och
            ...
            <Card className="border-accent/30">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-foreground leading-relaxed">
                  Bostadsannonser granskas för att upprätthålla kvalitet och
                  motverka vilseledande marknadsföring på plattformen.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-nordic-aurora/30">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-foreground leading-relaxed">
                  Alla säkerhetshändelser loggas och övervakas kontinuerligt för
                  att snabbt kunna upptäcka och åtgärda eventuella hot.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-warning/30">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-foreground leading-relaxed">
                  Strukturerad process för rapportering och hantering av
                  säkerhetsincidenter, bedrägerier och regelbrott.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/30">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-foreground leading-relaxed">
                  Vi arbetar för att efterleva EU:s DAC7-direktiv för
                  rapportering av hyresintäkter till Skatteverket där det är
                  tillämpligt.
                </p>
              </CardContent>
            </Card>
          ...
          <Card className="border-2 border-primary/20">
            <CardHeader>
              ...
              <p className="text-sm text-foreground">
                Läs våra policyer och villkor för att förstå hur vi hanterar
                dina uppgifter och vilka rättigheter du har som användare.
              </p>
            </CardHeader>
            <CardContent>
