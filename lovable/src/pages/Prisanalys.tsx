        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-foreground font-medium max-w-3xl mx-auto">
              Få trovärdiga värderingar och framtida prisförutsägelser baserat
              på marknadsdata och avancerad AI
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="mb-16">
            ...
            <p className="text-lg text-foreground font-medium leading-relaxed mb-6">
              ...
              aktuella marknadsförhållanden och avancerade prediktionsmodeller
              för att ge dig de mest trovärdiga värderingarna på
              bostadsmarknaden. Vi analyserar tusentals datapunkter för att
              förstå vad som påverkar priset på just din bostad.
            </p>
            <p className="text-lg text-foreground font-medium leading-relaxed">
              Med realtidsdata från hela svenska bostadsmarknaden kan vi inte
              bara berätta vad en bostad är värd idag, utan också prognostisera
              hur värdet kommer att utvecklas framåt. Detta ger dig ett tydligt
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Prisanalyser baserade på de senaste transaktionerna och
                    marknadsförändringar i realtid.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Se inte bara ett pris utan ett intervall med sannolikhet för
              ...
              <Card className="bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Djupgående analys av hur området påverkar priset och
                    framtida värdeutveckling.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    AI-baserade prognoser för hur priset förväntas utvecklas de
              ...
              <Card className="bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Jämför med liknande objekt i området för att se hur prisvärt
                    objektet är.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    Förstå exakt vilka faktorer som påverkar priset och hur
                    mycket varje faktor väger.
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Få en omedelbar värdering istället för att vänta på
                        mäklarbedömningar. Du kan analysera flera bostäder på
                        kort tid.
                      </p>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Med detaljerad prisanalys och jämförelser kan du
                        förhandla mer effektivt oavsett om du köper eller
                        säljer.
                      </p>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Prisförutsägelser hjälper dig att planera när det är
                        bäst att köpa eller sälja för maximal avkastning.
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-card/40 backdrop-blur-lg border border-primary-foreground/20">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold mb-2">
                        Objektivt beslutsunderlag
                      </h3>
                      <p className="text-muted-foreground">
                        AI-baserade analyser ger dig objektiva siffror utan
                        känslomässiga bedömningar eller säljintresse.
                      </p>
                    </div>
                  </div>
                </CardContent>
