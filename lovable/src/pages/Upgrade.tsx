...
const Upgrade = () => {
  const { user, subscriptionTier, isPro, refetchProfile, userRoles } =
    useAuth();
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-xl font-medium text-foreground max-w-2xl mx-auto">
              Få obegränsad tillgång till alla AI-verktyg utan några
              månadsgränser
            </p>
          </div>
        ...
        <main className="container mx-auto px-4 py-12">
          <div className="max-w-2xl mx-auto text-center space-y-6">
            ...
            <p className="text-xl font-medium text-foreground">
              Du har tillgång till alla premium-funktioner. Fortsätt utforska
              allt som Bostadsvyn har att erbjuda.
            </p>
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-sm font-medium text-foreground">
            Har du frågor om Pro-kontot?{" "}
            <a href="/fragor-svar" className="text-primary hover:underline">
