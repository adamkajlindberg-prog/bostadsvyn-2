...
serve(async (req) => {
  ...
  try {
    ...
    const { propertyData } = (await req.json()) as {
        ...
        messages: [
          {
            role: "system",
            content:
              "You are a professional Swedish real estate valuator with expertise in market analysis and property valuation. Always respond in Swedish and provide accurate, detailed valuations based on current market conditions.",
          },
          {
            role: "user",
            content: prompt,
